...
int     IMB_exrmultipart_begin_write (void *handle, const char *filename, int width, int height, int compress) { (void)handle; (void)filename; (void)width; (void)height; (void)compress; }
...
void    IMB_exrmultipart_write_channels  (void *handle) { (void)handle; }
