...
static PyObject* V24_PoseBonesDict_items(V24_BPy_PoseBonesDict *self)
{
	return PyDict_Items(self->bonesMap); 
}
//------------------------Pose.bones.keys()
//Returns a list of keys like dict.keys()
static PyObject* V24_PoseBonesDict_keys(V24_BPy_PoseBonesDict *self)
{
	return PyDict_Keys(self->bonesMap);
}
//------------------------Armature.bones.values()
//Returns a list of values like dict.values()
static PyObject* V24_PoseBonesDict_values(V24_BPy_PoseBonesDict *self)
{
...
static char V24_BPy_PoseBonesDict_doc[] = "This is an internal subobject of pose\
designed to act as a Py_PoseBone dictionary.";

//------------------------tp_methods
//This contains a list of all methods the object contains
static PyMethodDef V24_BPy_PoseBonesDict_methods[] = {
	{"items", (PyCFunction) V24_PoseBonesDict_items, METH_NOARGS, 
		"() - Returns the key:value pairs from the dictionary"},
	{"keys", (PyCFunction) V24_PoseBonesDict_keys, METH_NOARGS, 
		"() - Returns the keys the dictionary"},
	{"values", (PyCFunction) V24_PoseBonesDict_values, METH_NOARGS, 
		"() - Returns the values from the dictionary"},
	{NULL, NULL, 0, NULL}
};
//-----------------(internal)
static int V24_PoseBoneMapping_Init(PyObject *dictionary, ListBase *posechannels){
	bPoseChannel *pchan = NULL;
	PyObject *py_posechannel = NULL;

	for (pchan = posechannels->first; pchan; pchan = pchan->next){
		py_posechannel = V24_PyPoseBone_FromPosechannel(pchan);
		if (!py_posechannel)
			return -1;
...
//----------------- V24_BonesDict_InitBones
static int V24_PoseBonesDict_InitBones(V24_BPy_PoseBonesDict *self)
{
	PyDict_Clear(self->bonesMap);
	if (V24_PoseBoneMapping_Init(self->bonesMap, self->bones) == -1)
		return 0;
	return 1;
} 
...
static PyObject *V24_PoseBonesDict_repr(V24_BPy_PoseBonesDict *self)
{
	char buffer[128], *str;
	PyObject *key, *value;
	int pos = 0;
	...
	str = MEM_mallocN( 64 + ( PyDict_Size( self->bonesMap ) * 128), "V24_PoseBonesDict_repr" );
	str[0] = '\0';
...
static void V24_PoseBonesDict_dealloc(V24_BPy_PoseBonesDict * self)
{
	Py_DECREF(self->bonesMap);
	V24_PoseBonesDict_Type.tp_free(self);
	return;
}
//------------------------mp_length
//This gets the size of the dictionary
static int V24_PoseBonesDict_len(V24_BPy_PoseBonesDict *self)
{
	return BLI_countlist(self->bones);
}
//-----------------------mp_subscript
//This defines getting a bone from the dictionary - x = Bones['key']
static PyObject *V24_PoseBonesDict_GetItem(V24_BPy_PoseBonesDict *self, PyObject* key)
{ 
	PyObject *value = NULL;
	...
	return V24_EXPP_incr_ret(value);
}
//------------------TYPE_OBECT DEFINITION--------------------------
//Mapping Protocol
static PyMappingMethods V24_PoseBonesDict_MapMethods = {
	(inquiry) V24_PoseBonesDict_len,					//mp_length
	(binaryfunc)V24_PoseBonesDict_GetItem,		//mp_subscript
	0,														//mp_ass_subscript
};
//PoseBonesDict TypeObject
PyTypeObject V24_PoseBonesDict_Type = {
	PyObject_HEAD_INIT(NULL)			//tp_head
	0,												//tp_internal
	"PoseBonesDict",								//tp_name
	sizeof(V24_BPy_PoseBonesDict),					//tp_basicsize
	0,												//tp_itemsize
	(destructor)V24_PoseBonesDict_dealloc,		//tp_dealloc
	0,												//tp_print
	0,												//tp_getattr
	0,												//tp_setattr
	0,												//tp_compare
	(reprfunc) V24_PoseBonesDict_repr,				//tp_repr
	0,												//tp_as_number
	0,												//tp_as_sequence
	&V24_PoseBonesDict_MapMethods,				//tp_as_mapping
	0,												//tp_hash
	0,												//tp_call
	0,												//tp_str
	0,												//tp_getattro
	...
	V24_BPy_PoseBonesDict_doc,						//tp_doc
	0,												//tp_traverse
	0,												//tp_clear
	0,												//tp_richcompare
	0,												//tp_weaklistoffset
	0,												//tp_iter
	0,												//tp_iternext
	V24_BPy_PoseBonesDict_methods,				//tp_methods
	0,												//tp_members
	0,												//tp_getset
	0,												//tp_base
	0,												//tp_dict
...
//-----------------------V24_PyPoseBonesDict_FromPyPose
static PyObject *V24_PyPoseBonesDict_FromPyPose(V24_BPy_Pose *py_pose)
{
	V24_BPy_PoseBonesDict *py_posebonesdict = NULL;

	//create py object
	py_posebonesdict = (V24_BPy_PoseBonesDict *)V24_PoseBonesDict_Type.tp_alloc(&V24_PoseBonesDict_Type, 0); 
	if (!py_posebonesdict)
		goto RuntimeError;
	...
	if (!V24_PoseBonesDict_InitBones(py_posebonesdict))
		goto RuntimeError;
...
//####################################################
//------------------METHOD IMPLEMENTATIONS------------------------------
static PyObject *V24_Pose_update(V24_BPy_Pose *self)
{
	Object *daddy = NULL;
...
//------------------------tp_methods
//This contains a list of all methods the object contains
static PyMethodDef V24_BPy_Pose_methods[] = {
	{"update", (PyCFunction) V24_Pose_update, METH_NOARGS, 
...
static PyObject *V24_Pose_getBoneDict(V24_BPy_Pose *self, void *closure)
{
    return V24_EXPP_incr_ret((PyObject*)self->Bones);
}
//------------------------Pose.bones (setter)
//Sets the bones attribute
static int V24_Pose_setBoneDict(V24_BPy_Pose *self, PyObject *value, void *closure)
{
	goto AttributeError;
...
static PyGetSetDef V24_BPy_Pose_getset[] = {
	{"bones", (getter)V24_Pose_getBoneDict, (setter)V24_Pose_setBoneDict, 
		"The pose's Bone dictionary", NULL},
	{NULL, NULL, NULL, NULL, NULL}
};
//------------------------tp_dealloc
//This tells how to 'tear-down' our object when ref count hits 0
static void V24_Pose_dealloc(V24_BPy_Pose *self)
{
	Py_DECREF(self->Bones);
	V24_Pose_Type.tp_free(self);
	return;
}
//------------------------tp_cmp
//This compares 2 pose types
static int V24_Pose_compare(V24_BPy_Pose *a, V24_BPy_Pose *b )
{
	return ( a->pose== b->pose ) ? 0 : -1;
}
//------------------------tp_repr
//This is the string representation of the object
static PyObject *V24_Pose_repr(V24_BPy_Pose *self)
{
	return PyString_FromFormat( "[Pose \"%s\"]", self->name); 
}
//------------------------tp_doc
//The __doc__ string for this object
static char V24_BPy_Pose_doc[] = "This object wraps a Blender Pose object.";

//------------------TYPE_OBECT DEFINITION--------------------------
PyTypeObject V24_Pose_Type = {
	PyObject_HEAD_INIT(NULL)   //tp_head
	0,										//tp_internal
	"Pose",									//tp_name
	sizeof(V24_BPy_Pose),						//tp_basicsize
	0,										//tp_itemsize
	(destructor)V24_Pose_dealloc,				//tp_dealloc
	0,										//tp_print
	0,										//tp_getattr
	0,										//tp_setattr
	(cmpfunc)V24_Pose_compare,					//tp_compare
	(reprfunc)V24_Pose_repr,					//tp_repr
	0,										//tp_as_number
	0,										//tp_as_sequence
	0,										//tp_as_mapping
	0,										//tp_hash
	...
	0,										//tp_iter
	0,										//tp_iternext
	V24_BPy_Pose_methods,						//tp_methods
	0,										//tp_members
	V24_BPy_Pose_getset,						//tp_getset
	0,										//tp_base
	0,										//tp_dict
	0,										//tp_descr_get
	0,										//tp_descr_set
...
//------------------METHOD IMPLEMENTATIONS------------------------------
//------------------------------PoseBone.insertKey()
static PyObject *V24_PoseBone_insertKey(V24_BPy_PoseBone *self, PyObject *args)
{
	...
	if (!PyArg_ParseTuple(args, "O!i|Oi", &V24_Object_Type, &parent_object, &frame, &constants, &no_ipo_update ))
		goto AttributeError;
	...
	for (pchan = ((V24_BPy_Object*)parent_object)->object->pose->chanbase.first; 
	...
	if (!((V24_BPy_Object*)parent_object)->object->action){
	...
	if (constants){
		if(PySequence_Check(constants)){
			...
			for (x = 0; x < length; x++){
				...
				if (item == V24_EXPP_GetModuleConstant("Blender.Object.Pose", "ROT")){
					numeric_value |= POSE_ROT;
				}else if (item == V24_EXPP_GetModuleConstant("Blender.Object.Pose", "LOC")){
					numeric_value |= POSE_LOC;
				}else if (item == V24_EXPP_GetModuleConstant("Blender.Object.Pose", "SIZE")){
			...
			if (constants == V24_EXPP_GetModuleConstant("Blender.Object.Pose", "ROT")){
				...
				numeric_value |= POSE_LOC;
			}else if (constants == V24_EXPP_GetModuleConstant("Blender.Object.Pose", "SIZE")){
				numeric_value |= POSE_SIZE;
			}else{
				self->posechannel->flag = (short)oldflag;
				goto AttributeError4;
	...
	verify_action_channel(((V24_BPy_Object*)parent_object)->object->action, 
		self->posechannel->name);
	
	//insert the pose keys
	if (self->posechannel->flag & POSE_ROT){
		insertkey(&((V24_BPy_Object*)parent_object)->object->id, 
	...
	//update the IPOs
	if (no_ipo_update==0)
		remake_action_ipos (((V24_BPy_Object*)parent_object)->object->action);
...
//------------------------tp_methods
//This contains a list of all methods the object contains
static PyMethodDef V24_BPy_PoseBone_methods[] = {
	{"insertKey", (PyCFunction) V24_PoseBone_insertKey, METH_VARARGS, 
...
static PyObject *V24_PoseBone_getName(V24_BPy_PoseBone *self, void *closure)
{
    return PyString_FromString(self->posechannel->name);
}
//------------------------PoseBone.name (setter)
//Sets the name attribute
static int V24_PoseBone_setName(V24_BPy_PoseBone *self, PyObject *value, void *closure)
{
	char *name = "";
...
static int V24_PoseBone_setLoc(V24_BPy_PoseBone *self, PyObject *value, void *closure)
{
...
static int V24_PoseBone_setSize(V24_BPy_PoseBone *self, PyObject *value, void *closure)
{
	V24_VectorObject *vec = NULL;
	int x;
...
static int V24_PoseBone_setQuat(V24_BPy_PoseBone *self, PyObject *value, void *closure)
{
...
//Sets the chan_mat 
static int V24_PoseBone_setLocalMatrix(V24_BPy_PoseBone *self, PyObject *value, void *closure)
{
	V24_MatrixObject *matrix = NULL;
...
//Sets the pose_mat
static int V24_PoseBone_setPoseMatrix(V24_BPy_PoseBone *self, V24_MatrixObject *value, void *closure)
{
...
static PyObject *V24_PoseBone_getConstraints(V24_BPy_PoseBone *self, void *closure)
{
	return V24_PoseConstraintSeq_CreatePyObject( self->posechannel );
}
//------------------------PoseBone.limitmin (getter)
//Gets the pose bone limitmin value
static PyObject *V24_PoseBone_getLimitMin(V24_BPy_PoseBone *self, void *closure)
{
	float mylimitmin[3];
	Object *obj = NULL;

	obj = V24_Object_FromPoseChannel(self->posechannel);
	if (obj==NULL){
		return V24_EXPP_ReturnPyObjError(PyExc_AttributeError, "Bone data is not found");
	}
	mylimitmin[0]=0.0f;
	mylimitmin[1]=0.0f;
	mylimitmin[2]=0.0f;
...
static int V24_PoseBone_setLimitMin(V24_BPy_PoseBone *self, PyObject *value, void *closure)
{
	float newlimitmin[3];
	int x;
	Object *obj = NULL;
	if(!PySequence_Check(value)){
		return V24_EXPP_ReturnIntError(PyExc_AttributeError, "Argument is not a sequence");
	}
	if (PySequence_Size(value) !=3){
		return V24_EXPP_ReturnIntError(PyExc_AttributeError, "Argument size must be 3");
	}
	newlimitmin[0]=0.0f;
	newlimitmin[1]=0.0f;
	newlimitmin[2]=0.0f;
	...
	obj = V24_Object_FromPoseChannel(self->posechannel);
	if (obj==NULL){
		return V24_EXPP_ReturnIntError(PyExc_AttributeError, "Bone data is not found");
	}
	if(!pose_channel_in_IK_chain(obj, self->posechannel)){
		return V24_EXPP_ReturnIntError(PyExc_AttributeError, "Bone is not part of an IK chain");
	}
	if ((self->posechannel->ikflag & BONE_IK_NO_XDOF)==0) {
		if ((self->posechannel->ikflag & BONE_IK_XLIMIT)) {
			self->posechannel->limitmin[0] = V24_EXPP_ClampFloat(newlimitmin[0], -180.0f, 0.0f);
		}
	}
	if ((self->posechannel->ikflag & BONE_IK_NO_YDOF)==0) {
		if ((self->posechannel->ikflag & BONE_IK_YLIMIT)) {
			self->posechannel->limitmin[1] = V24_EXPP_ClampFloat(newlimitmin[1], -180.0f, 0.0f);
		}
	}
	if ((self->posechannel->ikflag & BONE_IK_NO_ZDOF)==0) {
		if ((self->posechannel->ikflag & BONE_IK_ZLIMIT)) {
			self->posechannel->limitmin[2] = V24_EXPP_ClampFloat(newlimitmin[2], -180.0f, 0.0f);
		}
	}
...
static PyObject *V24_PoseBone_getLimitMax(V24_BPy_PoseBone *self, void *closure)
{
	float mylimitmax[3];
	Object *obj = NULL;
...
static int V24_PoseBone_setLimitMax(V24_BPy_PoseBone *self, PyObject *value, void *closure)
{
	float newlimitmax[3];
	int x;
	Object *obj = NULL;
	...
	if ((self->posechannel->ikflag & BONE_IK_NO_XDOF)==0) {
		if ((self->posechannel->ikflag & BONE_IK_XLIMIT)) {
			self->posechannel->limitmax[0] = V24_EXPP_ClampFloat(newlimitmax[0], 0.0f, 180.0f);
		}
	}
	if ((self->posechannel->ikflag & BONE_IK_NO_YDOF)==0) {
		if ((self->posechannel->ikflag & BONE_IK_YLIMIT)) {
			self->posechannel->limitmax[1] = V24_EXPP_ClampFloat(newlimitmax[1], 0.0f, 180.0f);
		}
	}
	if ((self->posechannel->ikflag & BONE_IK_NO_ZDOF)==0) {
		if ((self->posechannel->ikflag & BONE_IK_ZLIMIT)) {
			self->posechannel->limitmax[2] = V24_EXPP_ClampFloat(newlimitmax[2], 0.0f, 180.0f);
		}
	}
	DAG_object_flush_update(G.scene, obj, OB_RECALC_DATA);
	return 0;
...
static PyObject *V24_PoseBone_getSelect(V24_BPy_PoseBone *self, void *closure)
{
...
static int V24_PoseBone_setSelect(V24_BPy_PoseBone *self, PyObject *value, void *closure)
{
...
static PyObject *V24_PoseBone_getParent(V24_BPy_PoseBone *self, void *closure)
{
	if (self->posechannel->parent)
		return V24_PyPoseBone_FromPosechannel(self->posechannel->parent);
	else
        Py_RETURN_NONE;
}
...
static PyObject *V24_PoseBone_getDisplayObject(V24_BPy_PoseBone *self, void *closure)
{
	if (self->posechannel->custom)
		return V24_Object_CreatePyObject(self->posechannel->custom);
	else
        Py_RETURN_NONE;
}
...
static int V24_PoseBone_setDisplayObject(V24_BPy_PoseBone *self, PyObject *value, void *closure)
{
	return V24_GenericLib_assignData(value, (void **) &self->posechannel->custom, 0, 0, ID_OB, 0);
}

//------------------------PoseBone.hasIK (getter)
//Returns True/False if the bone has IK's
static PyObject *V24_PoseBone_hasIK(V24_BPy_PoseBone *self, void *closure)
{
	Object *obj = NULL;
...
static PyObject *V24_PoseBone_getStretch(V24_BPy_PoseBone *self, void *closure)
{
...
static int V24_PoseBone_setStretch(V24_BPy_PoseBone *self, PyObject *value, void *closure)
{
	float ikstretch;
...
static PyObject *V24_PoseBone_getStiff(V24_BPy_PoseBone *self, void *axis)
{
...
static int V24_PoseBone_setStiff(V24_BPy_PoseBone *self, PyObject *value, void *axis)
{
	float stiff;
...
/*
static PyObject *PoseBone_getFlag(V24_BPy_PoseBone *self, void *flag)
{
...
//Gets the pose bones flag
/*
static int PoseBone_setFlag(V24_BPy_PoseBone *self, PyObject *value, void *flag)
{
...
static PyObject *V24_PoseBone_getIKFlag(V24_BPy_PoseBone *self, void *flag)
{
...
static int V24_PoseBone_setIKFlag(V24_BPy_PoseBone *self, PyObject *value, void *flag)
{
	int param = PyObject_IsTrue( value );
	if( param == -1 )
		return V24_EXPP_ReturnIntError( PyExc_TypeError,
...
//------------------------Bone.layerMask (get)
static PyObject *V24_PoseBone_getLayerMask(V24_BPy_PoseBone *self)
{
...
//------------------------Bone.layerMask (set)
static int V24_PoseBone_setLayerMask(V24_BPy_PoseBone *self, PyObject *value)
{
	int laymask;
...
//------------------------tp_getset
//This contains methods for attributes that require checking
static PyGetSetDef V24_BPy_PoseBone_getset[] = {
	{"name", (getter)V24_PoseBone_getName, (setter)V24_PoseBone_setName, 
		"The pose bone's name", NULL},
	{"loc", (getter)V24_PoseBone_getLoc, (setter)V24_PoseBone_setLoc, 
		"The pose bone's change in location as a vector", NULL},
	{"size", (getter)V24_PoseBone_getSize, (setter)V24_PoseBone_setSize, 
		"The pose bone's change in size as a vector", NULL},
	{"quat", (getter)V24_PoseBone_getQuat, (setter)V24_PoseBone_setQuat, 
		"The pose bone's change in rotation as a quat", NULL},
	{"localMatrix", (getter)V24_PoseBone_getLocalMatrix, (setter)V24_PoseBone_setLocalMatrix, 
		"The pose bone's change matrix built from the quat, loc, and size", NULL},
	{"poseMatrix", (getter)V24_PoseBone_getPoseMatrix, (setter)V24_PoseBone_setPoseMatrix, 
		"The pose bone's matrix", NULL},
	{"head", (getter)V24_PoseBone_getHead, (setter)V24_PoseBone_setHead, 
		"The pose bone's head positon", NULL},
	{"tail", (getter)V24_PoseBone_getTail, (setter)V24_PoseBone_setTail, 
		"The pose bone's tail positon", NULL},
	{"sel", (getter)V24_PoseBone_getSelect, (setter)V24_PoseBone_setSelect, 
		"The pose selection state", NULL},
    {"limitMin", (getter)V24_PoseBone_getLimitMin, (setter)V24_PoseBone_setLimitMin,
        "The pose bone dof min", NULL},
    {"limitMax", (getter)V24_PoseBone_getLimitMax, (setter)V24_PoseBone_setLimitMax,
        "The pose bone dof max", NULL},
	{"constraints", (getter)V24_PoseBone_getConstraints, (setter)NULL, 
		"The list of contraints that pertain to this pose bone", NULL},
	{"parent", (getter)V24_PoseBone_getParent, (setter)NULL, 
		"The bones parent (read only for posebones)", NULL},
	{"displayObject", (getter)V24_PoseBone_getDisplayObject, (setter)V24_PoseBone_setDisplayObject, 
		"The poseMode object to draw in place of this bone", NULL},
	
	{"hasIK", (getter)V24_PoseBone_hasIK, (setter)NULL, 
		"True if the pose bone has IK (readonly)", NULL },
	
	{"stretch", (getter)V24_PoseBone_getStretch, (setter)V24_PoseBone_setStretch, 
		"Stretch the bone to the IK Target", NULL },
		
	{"stiffX", (getter)V24_PoseBone_getStiff, (setter)V24_PoseBone_setStiff, 
		"bones stiffness on the X axis", (void *)0 },
	{"stiffY", (getter)V24_PoseBone_getStiff, (setter)V24_PoseBone_setStiff, 
		"bones stiffness on the Y axis", (void *)1 },
	{"stiffZ", (getter)V24_PoseBone_getStiff, (setter)V24_PoseBone_setStiff, 
		"bones stiffness on the Z axis", (void *)2 },
		
	{"limitX", (getter)V24_PoseBone_getIKFlag, (setter)V24_PoseBone_setIKFlag, 
		"limit rotation over X axis when part of an IK", (void *)BONE_IK_XLIMIT },
	{"limitY", (getter)V24_PoseBone_getIKFlag, (setter)V24_PoseBone_setIKFlag, 
		"limit rotation over Y axis when part of an IK", (void *)BONE_IK_YLIMIT },
	{"limitZ", (getter)V24_PoseBone_getIKFlag, (setter)V24_PoseBone_setIKFlag, 
		"limit rotation over Z axis when part of an IK", (void *)BONE_IK_ZLIMIT },
	
	{"lockXRot", (getter)V24_PoseBone_getIKFlag, (setter)V24_PoseBone_setIKFlag,
		"disable X DoF when part of an IK", (void *)BONE_IK_NO_XDOF },
	{"lockYRot", (getter)V24_PoseBone_getIKFlag, (setter)V24_PoseBone_setIKFlag, 
		"disable Y DoF when part of an IK", (void *)BONE_IK_NO_YDOF },
	{"lockZRot", (getter)V24_PoseBone_getIKFlag, (setter)V24_PoseBone_setIKFlag,
		"disable Z DoF when part of an IK", (void *)BONE_IK_NO_ZDOF },
	{"layerMask", (getter)V24_PoseBone_getLayerMask, (setter)V24_PoseBone_setLayerMask, 
		"Layer bitmask", NULL },
	{NULL, NULL, NULL, NULL, NULL}
};
//------------------------tp_dealloc
//This tells how to 'tear-down' our object when ref count hits 0
static void V24_PoseBone_dealloc(V24_BPy_PoseBone *self)
{
	V24_PoseBone_Type.tp_free(self);
	return;
}
//------------------------tp_repr
//This is the string representation of the object
static PyObject *V24_PoseBone_repr(V24_BPy_PoseBone *self)
{
	return PyString_FromFormat( "[PoseBone \"%s\"]", self->posechannel->name); 
}
//------------------------tp_doc
//The __doc__ string for this object
static char V24_BPy_PoseBone_doc[] = "This object wraps a Blender PoseBone object.";

//------------------TYPE_OBECT DEFINITION--------------------------
PyTypeObject V24_PoseBone_Type = {
	PyObject_HEAD_INIT(NULL)   //tp_head
	0,										//tp_internal
	"PoseBone",							//tp_name
	sizeof(V24_BPy_PoseBone),			//tp_basicsize
	0,										//tp_itemsize
	(destructor)V24_PoseBone_dealloc,		//tp_dealloc
	0,										//tp_print
	0,										//tp_getattr
	0,										//tp_setattr
	0,										//tp_compare
	(reprfunc)V24_PoseBone_repr,		//tp_repr
	0,										//tp_as_number
	0,										//tp_as_sequence
	0,										//tp_as_mapping
	0,										//tp_hash
	...
	0,										//tp_iter
	0,										//tp_iternext
	V24_BPy_PoseBone_methods,		//tp_methods
	0,										//tp_members
	V24_BPy_PoseBone_getset,			//tp_getset
	0,										//tp_base
	0,										//tp_dict
	0,										//tp_descr_get
	0,										//tp_descr_set
...
PyObject *V24_Pose_Init(void)
{
	...
	if (PyType_Ready(&V24_Pose_Type) < 0 || PyType_Ready(&V24_PoseBone_Type)  < 0 ||
		PyType_Ready(&V24_PoseBonesDict_Type) < 0) {
		Py_RETURN_NONE;
	}
	...
	PyModule_AddObject(module, "Pose", 
		V24_EXPP_incr_ret((PyObject *)&V24_Pose_Type)); //*steals*
	PyModule_AddObject(module, "PoseBone", 
		V24_EXPP_incr_ret((PyObject *)&V24_PoseBone_Type)); //*steals*

	//Add CONSTANTS to the module
	PyModule_AddObject(module, "ROT", 
		V24_PyConstant_NewInt("ROT", POSE_ROT));
	PyModule_AddObject(module, "LOC", 
		V24_PyConstant_NewInt("LOC", POSE_LOC));
	PyModule_AddObject(module, "SIZE", 
		V24_PyConstant_NewInt("SIZE", POSE_SIZE));

	return module;
}
//------------------VISIBLE PROTOTYPE IMPLEMENTATION-----------------------
//------------------------------V24_PyPose_FromPose (internal)
//Returns a PyPose from a bPose - return PyNone if bPose is NULL
PyObject *V24_PyPose_FromPose(bPose *pose, char *name)
{
	V24_BPy_Pose *py_pose = NULL;

	if (pose){
		py_pose = (V24_BPy_Pose*)V24_Pose_Type.tp_alloc(&V24_Pose_Type, 0);
		if (!py_pose)
			goto RuntimeError;
		...
		py_pose->Bones = (V24_BPy_PoseBonesDict*)V24_PyPoseBonesDict_FromPyPose(py_pose);
		if (!py_pose->Bones)
			goto RuntimeError;
...
{
	V24_BPy_PoseBone *py_posechannel = NULL;

	if (pchan){
		py_posechannel = (V24_BPy_PoseBone*)V24_PoseBone_Type.tp_alloc(&V24_PoseBone_Type, 0);
		if (!py_posechannel)
			goto RuntimeError;
