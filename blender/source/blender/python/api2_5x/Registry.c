/* 
 * $Id: Registry.c 11416 2007-07-29 14:30:06Z campbellbarton $
 *
...
/*****************************************************************************/
static PyObject *Registry_Keys( PyObject * self );
static PyObject *Registry_GetKey( PyObject * self, PyObject * args );
static PyObject *Registry_SetKey( PyObject * self, PyObject * args );
static PyObject *Registry_RemoveKey( PyObject * self, PyObject * args );
...
/*****************************************************************************/
struct PyMethodDef Registry_methods[] = {
	{"Keys", ( PyCFunction ) Registry_Keys, METH_VARARGS, Registry_Keys_doc},
	{"GetKey", Registry_GetKey, METH_VARARGS, Registry_GetKey_doc},
	{"SetKey", Registry_SetKey, METH_VARARGS, Registry_SetKey_doc},
	{"RemoveKey", Registry_RemoveKey, METH_VARARGS,
	 Registry_RemoveKey_doc},
	{NULL, NULL, 0, NULL}
};

/*****************************************************************************/
/* Function:              Registry_Keys                                    */
/* Python equivalent:     Blender.Registry.Keys                              */
/*****************************************************************************/
PyObject *Registry_Keys( PyObject * self )
{
...
PyObject *Registry_Init( void )
{
	...
	submodule = Py_InitModule3( "bpy.registry", Registry_methods,
				    Registry_doc );
