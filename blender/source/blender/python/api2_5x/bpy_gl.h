/* 
 * $Id: BGL.h 11416 2007-07-29 14:30:06Z campbellbarton $
 *
...
PyObject *GLBufferType_Init(void);
...
#define buffer_ref(number)  &BPyGLBuffer_Type, &bgl_buffer##number
#define buffer_def(number)  BPyGLBufferObject *bgl_buffer##number
...
#define GLbooleanP_ref(number)  &BPyGLBuffer_Type, &bgl_buffer##number
#define GLbooleanP_def(number)  BPyGLBufferObject *bgl_buffer##number

#define GLbyteP_str     "O!"
#define GLbyteP_var(number) (bgl_buffer##number)->buf.asvoid
#define GLbyteP_ref(number) &BPyGLBuffer_Type, &bgl_buffer##number
#define GLbyteP_def(number) BPyGLBufferObject *bgl_buffer##number

#define GLubyteP_str      "O!"
#define GLubyteP_var(number)  (bgl_buffer##number)->buf.asvoid
#define GLubyteP_ref(number)  &BPyGLBuffer_Type, &bgl_buffer##number
#define GLubyteP_def(number)  BPyGLBufferObject *bgl_buffer##number

#define GLintP_str      "O!"
#define GLintP_var(number)  (bgl_buffer##number)->buf.asvoid
#define GLintP_ref(number)  &BPyGLBuffer_Type, &bgl_buffer##number
#define GLintP_def(number)  BPyGLBufferObject *bgl_buffer##number

#define GLuintP_str     "O!"
#define GLuintP_var(number) (bgl_buffer##number)->buf.asvoid
#define GLuintP_ref(number) &BPyGLBuffer_Type, &bgl_buffer##number
#define GLuintP_def(number) BPyGLBufferObject *bgl_buffer##number

#define GLshortP_str      "O!"
#define GLshortP_var(number)  (bgl_buffer##number)->buf.asvoid
#define GLshortP_ref(number)  &BPyGLBuffer_Type, &bgl_buffer##number
#define GLshortP_def(number)  BPyGLBufferObject *bgl_buffer##number

#define GLushortP_str     "O!"
#define GLushortP_var(number) (bgl_buffer##number)->buf.asvoid
#define GLushortP_ref(number) &BPyGLBuffer_Type, &bgl_buffer##number
#define GLushortP_def(number) BPyGLBufferObject *bgl_buffer##number

#define GLfloatP_str      "O!"
#define GLfloatP_var(number)  (bgl_buffer##number)->buf.asvoid
#define GLfloatP_ref(number)  &BPyGLBuffer_Type, &bgl_buffer##number
#define GLfloatP_def(number)  BPyGLBufferObject *bgl_buffer##number

#define GLdoubleP_str     "O!"
#define GLdoubleP_var(number) (bgl_buffer##number)->buf.asvoid
#define GLdoubleP_ref(number) &BPyGLBuffer_Type, &bgl_buffer##number
#define GLdoubleP_def(number) BPyGLBufferObject *bgl_buffer##number

#define GLclampfP_str     "O!"
#define GLclampfP_var(number) (bgl_buffer##number)->buf.asvoid
#define GLclampfP_ref(number) &BPyGLBuffer_Type, &bgl_buffer##number
#define GLclampfP_def(number) BPyGLBufferObject *bgl_buffer##number

#define GLvoidP_str     "O!"
#define GLvoidP_var(number) (bgl_buffer##number)->buf.asvoid
#define GLvoidP_ref(number) &BPyGLBuffer_Type, &bgl_buffer##number
#define GLvoidP_def(number) BPyGLBufferObject *bgl_buffer##number
