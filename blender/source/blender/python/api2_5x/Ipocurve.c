/*
 * $Id: Ipocurve.c 12802 2007-12-06 00:01:46Z campbellbarton $
 *
...
/*****************************************************************************/
/* Python BPyIpoCurveObject methods declarations:                                  */
/*****************************************************************************/
static PyObject *IpoCurve_getName( BPyIpoCurveObject * self );
static PyObject *IpoCurve_Recalc( BPyIpoCurveObject * self );
static PyObject *IpoCurve_append( BPyIpoCurveObject * self, PyObject * args );
static PyObject *IpoCurve_delBezier( BPyIpoCurveObject * self, PyObject * args );

static PyObject *IpoCurve_newgetInterp( BPyIpoCurveObject * self );
static int IpoCurve_newsetInterp( BPyIpoCurveObject * self, PyObject * args );
static PyObject *IpoCurve_newgetExtend( BPyIpoCurveObject * self );
static int IpoCurve_newsetExtend( BPyIpoCurveObject * self, PyObject * args );
static PyObject *IpoCurve_getPoints( BPyIpoCurveObject * self );
static PyObject *IpoCurve_evaluate( BPyIpoCurveObject * self, PyObject * args );
static PyObject *IpoCurve_getDriver( BPyIpoCurveObject * self );
static int IpoCurve_setDriver( BPyIpoCurveObject * self, PyObject * args );
static PyObject *IpoCurve_getDriverObject( BPyIpoCurveObject * self);
static int IpoCurve_setDriverObject( BPyIpoCurveObject * self, PyObject * args );
static PyObject *IpoCurve_getDriverChannel( BPyIpoCurveObject * self);
static int IpoCurve_setDriverChannel( BPyIpoCurveObject * self, PyObject * args );
static PyObject *IpoCurve_getDriverExpression( BPyIpoCurveObject * self);
static PyObject *IpoCurve_getFlag( BPyIpoCurveObject * self, void *type);
static int IpoCurve_setFlag( BPyIpoCurveObject * self, PyObject *value, void *type);

static int IpoCurve_setDriverExpression( BPyIpoCurveObject * self, PyObject * args );
static PyObject *IpoCurve_getCurval( BPyIpoCurveObject * self, PyObject * args );
static int IpoCurve_setCurval( BPyIpoCurveObject * self, PyObject * key, 
		PyObject * value );

/*****************************************************************************/
/* Python BPyIpoCurveObject methods table:                                          */
/*****************************************************************************/
static PyMethodDef BPyIpoCurve_methods[] = {
...
/*****************************************************************************/
/* Python BPyIpoCurve_Type Mapping Methods table:                               */
/*****************************************************************************/
...
/*****************************************************************************/
/* Python BPyIpoCurve_Type callback function prototypes:                        */
/*****************************************************************************/
static int IpoCurve_compare( BPyIpoCurveObject * a, BPyIpoCurveObject * b );
static PyObject *IpoCurve_repr( BPyIpoCurveObject * self );

/*****************************************************************************/
/* Python BPyIpoCurve_Type structure definition:                                */
/*****************************************************************************/
PyTypeObject BPyIpoCurve_Type = {
	PyObject_HEAD_INIT( NULL )          /* required macro */ 
	0,									/* ob_size */
	"IpoCurve",							/* tp_name */
	sizeof( BPyIpoCurveObject ),				/* tp_basicsize */
	0,									/* tp_itemsize */
	/* methods */
	NULL,							    /* tp_dealloc */
	0,									/* tp_print */
  ...
  /*** Attribute descriptor and subclassing stuff ***/
	BPyIpoCurve_methods,           		/* struct PyMethodDef *tp_methods; */
	NULL,                       		/* struct PyMemberDef *tp_members; */
	BPyIpoCurve_getset,					/* struct PyGetSetDef *tp_getset; */
...
/*****************************************************************************/
/* Python BPyIpoCurveObject methods:                                                */
/*****************************************************************************/
...
static PyObject *IpoCurve_append( BPyIpoCurveObject * self, PyObject * args )
{
	...
	if( BPyBezTriple_Check ( obj ) ) {
		BPyBezTripleObject *bobj = (BPyBezTripleObject *)obj;
...
/* Description: This is a callback function for the BPyIpoCurveObject type. It      */
...
/* Three Python BPyIpoCurve_Type helper functions needed by the Object module: */

/*****************************************************************************/
/* Function:    IpoCurve_CreatePyObject                                     */
/* Description: This function will create a new BPyIpoCurveObject from an existing  */
/*              Blender ipo structure.                                       */
/*****************************************************************************/
PyObject *IpoCurve_CreatePyObject( IpoCurve * icu )
{
	BPyIpoCurveObject *pyipo;

	pyipo = ( BPyIpoCurveObject * ) PyObject_NEW( BPyIpoCurveObject, &BPyIpoCurve_Type );

	if( !pyipo )
		return EXPP_ReturnPyObjError( PyExc_MemoryError,
					      "couldn't create BPyIpoCurveObject object" );
...
static PyObject *IpoCurve_getDriverObject( BPyIpoCurveObject * self )
{
	return Object_CreatePyObject( self->ipocurve->driver->ob );
}

static int IpoCurve_setDriverObject( BPyIpoCurveObject * self, PyObject * arg )
{
	IpoCurve *ipo = self->ipocurve;
	...
	if(!BPyObject_Check(arg) )
		return EXPP_ReturnIntError( PyExc_RuntimeError,
					      "expected an object argument" );
	ipo->driver->ob = ((BPyObject *)arg)->object;
...
static int IpoCurve_setDriverExpression( BPyIpoCurveObject * self, PyObject * arg )
{
	IpoCurve *ipo = self->ipocurve;
...
static constIdents interpTypesIdents[] = {
	{"CONST",   		{(int)IPO_CONST}},
	{"LINEAR",			{(int)IPO_LIN}},
	{"BEZIER",			{(int)IPO_BEZ}},
};
...
static constDefinition interpTypes = {
	EXPP_CONST_INT, "ExtendTypes",
		sizeof(interpTypesIdents)/sizeof(constIdents), interpTypesIdents
};


PyObject *IpoCurveType_Init( void )
{
	/* only allocate new dictionary once */
	if( BPyIpoCurve_Type.tp_dict == NULL ) {
		BPyIpoCurve_Type.tp_dict = PyDict_New();
		PyConstCategory_AddObjectToDict( BPyIpoCurve_Type.tp_dict, &extendTypes );
		PyConstCategory_AddObjectToDict( BPyIpoCurve_Type.tp_dict, &interpTypes );
		PyType_Ready( &BPyIpoCurve_Type ) ;
	}
	return (PyObject *) &BPyIpoCurve_Type ;
}
...
static int IpoCurve_newsetInterp( BPyIpoCurveObject * self, PyObject * value )
{
...
static int IpoCurve_newsetExtend( BPyIpoCurveObject * self, PyObject * value )
{
