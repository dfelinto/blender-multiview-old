/* 
 * $Id: bpy_config.h 11416 2007-07-29 14:30:06Z campbellbarton $
 *
...
extern PyTypeObject BPyConfig_Type;

#define BPyConfig_Check(v) PyObject_TypeCheck(v, &BPyConfig_Type)
