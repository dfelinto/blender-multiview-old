/*
 * $Id: SurfNurb.c 11446 2007-07-31 16:11:32Z campbellbarton $
...
static int SurfNurb_setPoint( BPySurfNurbObject * self, int index, PyObject * ob );
static int SurfNurb_length( PyInstanceObject * inst );
static PyObject *SurfNurb_getIter( BPySurfNurbObject * self );
static PyObject *SurfNurb_iterNext( BPySurfNurbObject * self );
PyObject *SurfNurb_append( BPySurfNurbObject * self, PyObject * args );
...
static PyMethodDef BPySurfNurb_methods[] = {
# if 0
...
static PyObject *SurfNurb_getMatIndex( BPySurfNurbObject * self )
{
...
static int SurfNurb_setMatIndex( BPySurfNurbObject * self, PyObject * args )
{
...
static PyObject *SurfNurb_getPointsU( BPySurfNurbObject * self )
{
...
static PyObject *SurfNurb_getPointsV( BPySurfNurbObject * self )
{
...
static PyObject *SurfNurb_getFlagU( BPySurfNurbObject * self )
{
...
static int SurfNurb_setFlagU( BPySurfNurbObject * self, PyObject * args )
{
	int flagu;
...
static PyObject *SurfNurb_getFlagV( BPySurfNurbObject * self )
{
...
static int SurfNurb_setFlagV( BPySurfNurbObject * self, PyObject * args )
{
	int flagv;
...
static PyObject *SurfNurb_getOrderU( BPySurfNurbObject * self )
{
	return PyInt_FromLong( ( long ) self->nurb->orderu );
}

static int SurfNurb_setOrderU( BPySurfNurbObject * self, PyObject * args )
{
	int order;
...
static PyObject *SurfNurb_getOrderV( BPySurfNurbObject * self )
{
	return PyInt_FromLong( ( long ) self->nurb->orderv );
}

static int SurfNurb_setOrderV( BPySurfNurbObject * self, PyObject * args )
{
	int order;
...
static PyObject *SurfNurb_getCyclicU( BPySurfNurbObject * self )
{
...
static PyObject *SurfNurb_getCyclicV( BPySurfNurbObject * self )
{
...
static int SurfNurb_setCyclicU( BPySurfNurbObject * self, PyObject * args )
{
...
static int SurfNurb_setCyclicV( BPySurfNurbObject * self, PyObject * args )
{
	if( PyObject_IsTrue( args ) )
...
static int SurfNurb_length( PyInstanceObject * inst )
{
	...
	if( BPySurfNurb_Check( ( PyObject * ) inst ) ) {
		nurb = ( ( BPySurfNurbObject * ) inst )->nurb;
		return (int)(nurb->pntsu * nurb->pntsu);
	}

	return EXPP_ReturnIntError( PyExc_RuntimeError,
				    "arg is not a BPySurfNurbObject" );
}
 ...
 * it is called via the [] = operator, not as a usual instance method.
 */
static int SurfNurb_setPoint( BPySurfNurbObject * self, int index, PyObject * pyOb )
{
	Nurb *nurb = self->nurb;
	int size;
...
static PyGetSetDef BPySurfNurb_getset[] = {
#if 0
	{"matIndex",
 ...
 * blender data.
*/
static int SurfNurb_compare( BPySurfNurbObject * a, BPySurfNurbObject * b )
{
 ...
 *  SurfNurb_repr
 */
static PyObject *SurfNurb_repr( BPySurfNurbObject * self )
{
	return PyString_FromFormat( "[SurfNurb \"%d\"]", self->nurb->type );
}

/*****************************************************************************/
/* Python BPySurfNurb_Type structure definition:                                */
/*****************************************************************************/
PyTypeObject BPySurfNurb_Type = {
	PyObject_HEAD_INIT( NULL )  /* required py macro */
	0,                          /* ob_size */
	/*  For printing, in format "<module>.<name>" */
	"SurfNurb",                 /* char *tp_name; */
	sizeof( BPySurfNurbObject ),     /* int tp_basicsize; */
  ...
  /*** Attribute descriptor and subclassing stuff ***/
	BPySurfNurb_methods,       /* struct PyMethodDef *tp_methods; */
	NULL,                       /* struct PyMemberDef *tp_members; */
	BPySurfNurb_getset,     /* struct PyGetSetDef *tp_getset; */
...
/*
  factory method to create a BPySurfNurbObject from a Blender Nurb
*/

PyObject *SurfNurb_CreatePyObject( Nurb * blen_nurb )
{
	BPySurfNurbObject *pyNurb;

	if (!blen_nurb)
		Py_RETURN_NONE;
	
	pyNurb = ( BPySurfNurbObject * ) PyObject_NEW( BPySurfNurbObject, &BPySurfNurb_Type );

	if( !pyNurb )
		return EXPP_ReturnPyObjError( PyExc_MemoryError,
					      "could not create BPySurfNurbObject PyObject" );
