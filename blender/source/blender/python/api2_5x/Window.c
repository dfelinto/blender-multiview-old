/* 
 * $Id: Window.c 12802 2007-12-06 00:01:46Z campbellbarton $
 *
...
/*****************************************************************************/
PyObject *M_Window_Play( PyObject * self, PyObject * args );
...
/*****************************************************************************/
struct PyMethodDef Window_methods[] = {
	{"Play", M_Window_Play, METH_VARARGS, M_Window_Play_doc},
	{"CloseRenderWindow", M_Window_CloseRenderWindow, METH_NOARGS, M_Window_CloseRenderWindow_doc},
...
static PyObject *M_Window_GetViewMatrix( PyObject * self )
{
	...
	return Matrix_CreatePyObject( ( float * ) G.vd->viewmat, 4, 4, (PyObject *)NULL );
}
...
static PyObject *M_Window_GetPerspMatrix( PyObject * self )
{
	...
	return Matrix_CreatePyObject( ( float * ) G.vd->persmat, 4, 4, (PyObject *)NULL );
}
...
static constIdents windowTypesIdents[] = {
	...
	{"TEXT",				{(int)SPACE_TEXT}},
	{"NLA",					{(int)SPACE_NLA}},
	{"SCRIPT",				{(int)SPACE_SCRIPT}},
	{"TIME",				{(int)SPACE_TIME}},
	{"NODE",				{(int)SPACE_NODE}},
};
static constDefinition windowTypes = {
	EXPP_CONST_INT, "Types",
		sizeof(windowTypesIdents)/sizeof(constIdents), windowTypesIdents
};

static constIdents qualTypesIdents[] = {
	{"LALT",				{(int)L_ALTKEY}},
	{"RALT",				{(int)R_ALTKEY}},
	{"ALT",					{(int)LR_ALTKEY}},
	{"LCTRL",				{(int)L_CTRLKEY}},
	{"RCTRL",				{(int)R_CTRLKEY}},
	{"CTRL",				{(int)LR_CTRLKEY}},
	{"LSHIFT",				{(int)L_SHIFTKEY}},
	{"RSHIFT",				{(int)R_SHIFTKEY}},
	{"SHIFT",				{(int)LR_SHIFTKEY}},
};
static constDefinition qualTypes = {
	EXPP_CONST_INT, "Qual",
		sizeof(qualTypesIdents)/sizeof(constIdents), qualTypesIdents
};

static constIdents mbutTypesIdents[] = {
	{"L",					{(int)L_MOUSE}},
	{"M",					{(int)M_MOUSE}},
	{"R",					{(int)R_MOUSE}},
};
static constDefinition mbutTypes = {
	EXPP_CONST_INT, "MButs",
		sizeof(mbutTypesIdents)/sizeof(constIdents), mbutTypesIdents
};
/*****************************************************************************/
...
PyObject *Window_Init( void )
{
	...
	submodule = Py_InitModule3( "bpy.window", Window_methods,	"" );
	
	dict = PyModule_GetDict( submodule );

	PyConstCategory_AddObjectToDict( dict, &windowTypes );
	PyConstCategory_AddObjectToDict( dict, &qualTypes );
	PyConstCategory_AddObjectToDict( dict, &mbutTypes );
