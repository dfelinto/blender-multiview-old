/* 
 * $Id: sceneRadio.c 11346 2007-07-23 06:16:25Z campbellbarton $
 *
...
static PyObject *Radio_collectMeshes( BPyRadioObject * self );
static PyObject *Radio_go( BPyRadioObject * self );
static PyObject *Radio_freeData( BPyRadioObject * self );
static PyObject *Radio_replaceMeshes( BPyRadioObject * self );
static PyObject *Radio_addMesh( BPyRadioObject * self );
static PyObject *Radio_filterFaces( BPyRadioObject * self );
static PyObject *Radio_filterElems( BPyRadioObject * self );
static PyObject *Radio_limitSubdivide( BPyRadioObject * self );
static PyObject *Radio_subdividePatches( BPyRadioObject * self );
static PyObject *Radio_subdivideElems( BPyRadioObject * self );
static PyObject *Radio_removeDoubles( BPyRadioObject * self );

static PyObject *Radio_repr( BPyRadioObject * self );
...
static PyObject *Radio_get_hemires( BPyRadioObject * self )
{
...
static PyObject *Radio_get_maxiter( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_subshootp( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_subshoote( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_nodelim( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_maxsublamp( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_pama( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_pami( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_elma( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_elmi( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_drawtype( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_flag( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_maxnode( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_convergence( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_radfac( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_get_gamma( BPyRadioObject * self )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_set_hemires( BPyRadioObject * self, PyObject * args )
{
	PyObject *ret;
...
static PyObject *Radio_set_maxiter( BPyRadioObject * self, PyObject * args )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_set_subshootp( BPyRadioObject * self, PyObject * args )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_set_subshoote( BPyRadioObject * self, PyObject * args )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_set_nodelim( BPyRadioObject * self, PyObject * args )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_set_maxsublamp( BPyRadioObject * self, PyObject * args )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_set_pama( BPyRadioObject * self, PyObject * args )
{
	PyObject *ret;
...
static PyObject *Radio_set_pami( BPyRadioObject * self, PyObject * args )
{
	PyObject *ret;
...
static PyObject *Radio_set_elma( BPyRadioObject * self, PyObject * args )
{
	PyObject *ret;
...
static PyObject *Radio_set_elmi( BPyRadioObject * self, PyObject * args )
{
	PyObject *ret;
...
static PyObject *Radio_set_drawtype( BPyRadioObject * self, PyObject * args )
{
	PyObject *pyob = NULL;
	char *str = NULL;
...
static PyObject *Radio_set_flag( BPyRadioObject * self, PyObject * args )
{
	int i, imode = 0;
...
static PyObject *Radio_set_maxnode( BPyRadioObject * self, PyObject * args )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_set_convergence( BPyRadioObject * self, PyObject * args )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyObject *Radio_set_radfac( BPyRadioObject * self, PyObject * args )
{
	PyObject *ret;
...
static PyObject *Radio_set_gamma( BPyRadioObject * self, PyObject * args )
{
	if( !EXPP_check_scene( self->scene ) )
		return NULL;
...
static PyMethodDef BPyRadio_methods[] = {
...
static PyTypeObject Radio_Type = {
	...
	sizeof( BPyRadioObject ),	/*tp_basicsize */
	0,			/*tp_itemsize */
	NULL,		/*tp_dealloc */
	0,			/*tp_print */
	0,			/*tp_getattr */
...
PyObject *Radio_CreatePyObject( struct Scene * scene )
{
	...
	py_radio = ( BPyRadioObject * ) PyObject_NEW( BPyRadioObject, &Radio_Type );
...
static constIdents radioModeIdents[] = {
	{"ShowLimits",				{(int)EXPP_RADIO_flag_SHOWLIM}},
	{"Z",						{(int)EXPP_RADIO_flag_Z}},
};
static constDefinition radioMode = {
	EXPP_CONST_INT, "Modes",
		sizeof(radioModeIdents)/sizeof(constIdents), radioModeIdents
};

static constIdents drawTypesIdents[] = {
	{"Wire",					{(int)EXPP_RADIO_drawtype_WIRE}},
	{"Solid",					{(int)EXPP_RADIO_drawtype_SOLID}},
	{"Gouraud",					{(int)EXPP_RADIO_drawtype_GOURAUD}},
};
...
PyObject *Radio_Init( void )
{
	...
	submodule = Py_InitModule3( "Blender.Scene.Radio", NULL,
				    "The Blender Radiosity submodule" );

	dict = PyModule_GetDict( submodule );

	PyConstCategory_AddObjectToDict( dict, &radioMode );
	PyConstCategory_AddObjectToDict( dict, &drawTypes );
