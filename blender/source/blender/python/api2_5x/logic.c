/* 
 * $Id: logic.c 11416 2007-07-29 14:30:06Z campbellbarton $
 *
...
//--------------- Python BPyGamePropObject methods declarations:---------------
static PyObject *Property_getName( BPyGamePropObject * self );
static PyObject *Property_setName( BPyGamePropObject * self, PyObject * args );
static PyObject *Property_getData( BPyGamePropObject * self );
static PyObject *Property_setData( BPyGamePropObject * self, PyObject * args );
static PyObject *Property_getType( BPyGamePropObject * self );
//--------------- Python BPyGamePropObject methods table:----------------------
static PyMethodDef BPyProperty_methods[] = {
...
static void Property_dealloc( BPyGamePropObject * Property );
static PyObject *Property_getAttr( BPyGamePropObject * Property, char *name );
static int Property_setAttr( BPyGamePropObject * Property, char *name,
			     PyObject * v );
static PyObject *Property_repr( BPyGamePropObject * Property );
static int Property_compare( BPyGamePropObject * a1, BPyGamePropObject * a2 );
//--------------- Python TypeProperty structure definition----------------
PyTypeObject BPyGameProperty_Type = {
	PyObject_HEAD_INIT( NULL ) 
	0,	/* ob_size */
	"Blender Property",	/* tp_name */
	sizeof( BPyGamePropObject ),	/* tp_basicsize */
	0,			/* tp_itemsize */
	/* methods */
	...
	0,			/* tp_doc */
	0, 0, 0, 0, 0, 0,
	BPyProperty_methods,	/* tp_methods */
	0,			/* tp_members */
...
//--------------- checkValidData_ptr--------------------------------
static int checkValidData_ptr( BPyGamePropObject * self )
{
	int length;
...
//---------------BPyGamePropObject internal callbacks/methods------------

//--------------- dealloc-------------------------------------------
static void Property_dealloc( BPyGamePropObject * self )
{
...
//---------------getattr--------------------------------------------
static PyObject *Property_getAttr( BPyGamePropObject * self, char *name )
{
	...
	return Py_FindMethod( BPyProperty_methods, ( PyObject * ) self,
			      name );
}

//--------------- setattr-------------------------------------------
static int
Property_setAttr( BPyGamePropObject * self, char *name, PyObject * value )
{
	PyObject *valtuple;
	PyObject *error = NULL;
...
//--------------- repr----------------------------------------------
static PyObject *Property_repr( BPyGamePropObject * self )
{
	checkValidData_ptr( self );
	if( self->property ) {
...
static int Property_compare( BPyGamePropObject * a, BPyGamePropObject * b )
{
	BPyGamePropObject *py_propA, *py_propB;
	int retval = -1;
...
{
	BPyGamePropObject *py_property;

	py_property =
		( BPyGamePropObject * ) PyObject_NEW( BPyGamePropObject,
						 &BPyGameProperty_Type );
...
//--------------- Python BPyGamePropObject methods-----------------------
//--------------- BPyGamePropObject.getName()----------------------------
static PyObject *Property_getName( BPyGamePropObject * self )
{
	PyObject *attr = NULL;
...
{
	PyType_Ready( &BPyGameProperty_Type );
	return (PyObject *) &BPyGameProperty_Type;
}
