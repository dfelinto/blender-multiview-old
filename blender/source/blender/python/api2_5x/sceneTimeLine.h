/* 
 * $Id: sceneTimeLine.h 11398 2007-07-28 06:28:33Z campbellbarton $
 *
...
#define BPyTimeLine_Check(v)	PyObject_TypeCheck(v, &TimeLine_Type)

typedef struct {
	PyObject_HEAD
	BPySceneObject *bpysce;
	int iter;
} BPyTimeLineObject;

//---------------------------Python BPyTimeLineObject visible prototypes-----------
