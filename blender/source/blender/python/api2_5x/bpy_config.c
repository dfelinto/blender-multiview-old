/* 
 * $Id: bpy_config.c 11934 2007-09-03 20:57:12Z campbellbarton $
 *
...
{
	BPyConfigObject *conf = PyObject_NEW( BPyConfigObject, &BPyConfig_Type);
 ...
 */
static PyObject *Config_repr( BPyConfigObject * self )
{
...
/* see Main.c */
/*
static struct PyMethodDef BPyConfig_methods[] = {
 ...
 */
static PyObject *getStrAttr( BPyConfigObject *self, void *type )
{
	PyObject *attr = NULL;
	char *param = NULL;
...
static int setStrAttr( BPyConfigObject *self, PyObject *value, void *type )
{
	char *param;
	int len=160;
...
static PyObject *getIntAttr( BPyConfigObject *self, void *type )
{
	PyObject *attr = NULL;
	int param;
...
static int setIntAttrClamp( BPyConfigObject *self, PyObject *value, void *type )
{
	void *param;
	int min, max, size;
...
static PyGetSetDef Config_getset[] = {
	...
	{"rt",
	 (getter)getIntAttr, (setter)setIntAttrClamp,
	 "General testing/debugging setting",
	 (void *)EXPP_CONF_ATTR_RT},
...
/*
 *  Python BPyConfig_Type structure definition
 */
PyTypeObject BPyConfig_Type = {
	PyObject_HEAD_INIT( NULL )  /* required py macro */
	0,                          /* ob_size */
	/*  For printing, in format "<module>.<name>" */
	"Blender Config",           /* char *tp_name; */
	sizeof( BPyConfigObject ),       /* int tp_basicsize; */
  ...
  /*** Attribute descriptor and subclassing stuff ***/
	NULL,  /*BPyConfig_methods*/     /* struct PyMethodDef *tp_methods; */
