/* 
 * $Id: meshPrimitive.c 11936 2007-09-04 05:22:42Z campbellbarton $
 *
		...
		short subdiv, float dia, float height, short ext, short fill )
{
	...
	/* create the BPyMeshObject that wraps this mesh */
...
PyObject *M_MeshPrim_Plane( PyObject *self_unused, PyObject *args )
{
	float size = 2.0;
...
PyObject *M_MeshPrim_Cube( PyObject *self_unused, PyObject *args )
{
	float height = 2.0;
	float dia;
...
PyObject *M_MeshPrim_Circle( PyObject *self_unused, PyObject *args )
{
	int tot = 32;
	float size = 2;
...
PyObject *M_MeshPrim_Cylinder( PyObject *self_unused, PyObject *args )
{
	int tot = 32;
	float size = 2.0;
	float len = 2.0;
...
PyObject *M_MeshPrim_Tube( PyObject *self_unused, PyObject *args )
{
	int tot = 32;
	float size = 2.0;
	float len = 2.0;
...
PyObject *M_MeshPrim_Cone( PyObject *self_unused, PyObject *args )
{
	int tot = 32;
	float size = 2.0;
	float len = 2.0;
...
PyObject *M_MeshPrim_Grid( PyObject *self_unused, PyObject *args )
{
	int xres = 32;
	int yres = 32;
	float size = 2.0;
...
PyObject *M_MeshPrim_UVsphere( PyObject *self_unused, PyObject *args )
{
	int segs = 32;
	int rings = 32;
	float size = 2.0;
...
PyObject *M_MeshPrim_Icosphere( PyObject *self_unused, PyObject *args )
{
	int subdiv = 2;
	float size = 2.0;
...
PyObject *M_MeshPrim_Suzanne( PyObject *self_unused, PyObject *args )
{
