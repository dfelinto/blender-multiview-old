/**
 * $Id: Library.c 11446 2007-07-31 16:11:32Z campbellbarton $
 *
...
{
	BPyLibraryDataObject *seq = PyObject_NEW( BPyLibraryDataObject, &BPyLibraryData_Type);
...
static PyObject *lib_link_or_append( BPyLibraryDataObject *self, PyObject * args,
		int mode )
{
	char *name;
...
/************************************************************
 * Python BPyLibraryData_Type getset
 ************************************************************/

/* .append(): make a local copy of the library's data (except for objects) */

static PyObject *LibraryData_getAppend( BPyLibraryDataObject *self, PyObject * args)
{
...
static PyObject *LibraryData_getLink( BPyLibraryDataObject *self, PyObject * args)
{
	return lib_link_or_append( self, args, OBJECT_IS_LINK );
}

/************************************************************************
 * Python BPyLibraryData_Type iterator
 ************************************************************************/

/* Create and initialize the interator indices */

static PyObject *LibraryData_getIter( BPyLibraryDataObject * self )
{
	char longFilename[FILE_MAX];
	BlendHandle *openlib;
	LinkNode *names;
...
static PyObject *LibraryData_nextIter( BPyLibraryDataObject * self )
{
...
static struct PyMethodDef BPyLibraryData_methods[] = {
...
static void LibraryData_dealloc( BPyLibraryDataObject * self )
{
	if( self->name )
		MEM_freeN( self->name );
...
static PyObject *LibraryData_repr( BPyLibraryDataObject * self )
{
	char *linkstate = "";
	char *str = GenericLib_libname(self->type);
...
PyTypeObject BPyLibraryData_Type = {
	PyObject_HEAD_INIT( NULL )  /* required py macro */
	0,                          /* ob_size */
	/*  For printing, in format "<module>.<name>" */
	"Blender LibData",          /* char *tp_name; */
	sizeof( BPyLibraryDataObject ),  /* int tp_basicsize; */
  ...
  /*** Attribute descriptor and subclassing stuff ***/
	BPyLibraryData_methods,    /* struct PyMethodDef *tp_methods; */
...
static PyObject *LibraryData_CreatePyObject( BPyLibraryObject *self, void *mode )
{
...
static PyObject *Library_getFilename( BPyLibraryObject * self )
{
...
static int Library_setFilename( BPyLibraryObject * self, PyObject * args )
{
...
static PyGetSetDef Library_getset[] = {
	{"filename",
...
static PyObject *M_Library_Load(PyObject *self, PyObject * args)
{
	...
	lib = (BPyLibraryObject *)PyObject_NEW( BPyLibraryObject, &BPyLibrary_Type );
	if( !lib )
		return NULL;
...
/*****************************************************************************/
/* Python BPyLibrary_Type structure definition:                               */
/*****************************************************************************/
PyTypeObject BPyLibrary_Type = {
	PyObject_HEAD_INIT( NULL )  /* required py macro */
	0,                          /* ob_size */
	/*  For printing, in format "<module>.<name>" */
	"Blender Library",          /* char *tp_name; */
	sizeof( BPyLibraryObject ),      /* int tp_basicsize; */
	0,                          /* tp_itemsize;  For allocation */
  ...
  /*** Attribute descriptor and subclassing stuff ***/
	...
	NULL,                       /* struct PyMemberDef *tp_members; */
	Library_getset,				/* struct PyGetSetDef *tp_getset; */
	NULL,                       /* struct _typeobject *tp_base; */
	NULL,                       /* PyObject *tp_dict; */
	NULL,                       /* descrgetfunc tp_descr_get; */
	NULL,                       /* descrsetfunc tp_descr_set; */
...
{
	PyType_Ready( &BPyLibraryData_Type );
	return (PyObject *) &BPyLibraryData_Type;
}
...
PyObject *Library_Init( void )
{
	...
	submodule = Py_InitModule3( "bpy.libraries", M_Library_methods,
			M_newLibrary_doc );
	return submodule;
}
