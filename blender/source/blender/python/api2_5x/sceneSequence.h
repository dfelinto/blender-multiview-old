/* 
 * $Id: sceneSequence.h 11416 2007-07-29 14:30:06Z campbellbarton $
 *
...
extern PyTypeObject BPySequence_Type;
extern PyTypeObject BPySceneSeq_Type;

#define BPySequence_Check(v)		PyObject_TypeCheck(v, &BPySequence_Type)
#define BPySceneSeq_Check(v)		PyObject_TypeCheck(v, &BPySceneSeq_Type)

/*****************************************************************************/
/* Python BPySequenceObject structure definition.                                  */
/*****************************************************************************/
typedef struct {
...
#define Sequence_FromPyObject(py_obj) ((( BPySequenceObject * ) py_obj )->seq)
