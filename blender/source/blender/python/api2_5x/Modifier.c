/*
 * $Id: Modifier.c 12802 2007-12-06 00:01:46Z campbellbarton $
 *
...
/*****************************************************************************/
/* Python BPyModifierObject methods declarations:                                 */
/*****************************************************************************/
static PyObject *Modifier_getName( BPyModifierObject * self );
static int Modifier_setName( BPyModifierObject * self, PyObject *arg );
static PyObject *Modifier_getType( BPyModifierObject * self );
static PyObject *Modifier_reset( BPyModifierObject * self );

static PyObject *Modifier_getData( BPyModifierObject * self, PyObject * key );
static int Modifier_setData( BPyModifierObject * self, PyObject * key, 
		PyObject * value );

/*****************************************************************************/
/* Python BPyModifierObject methods table:                                        */
/*****************************************************************************/
static PyMethodDef BPyModifier_methods[] = {
...
/*****************************************************************************/
/* Python BPyModifierObject attributes get/set structure:                         */
/*****************************************************************************/
static PyGetSetDef BPyModifier_getset[] = {
	{"name",
...
/*****************************************************************************/
/* Python BPyModifier_Type Mapping Methods table:                               */
/*****************************************************************************/
...
/*****************************************************************************/
/* Python BPyModifier_Type callback function prototypes:                        */
/*****************************************************************************/
static PyObject *Modifier_repr( BPyModifierObject * self );

/*****************************************************************************/
/* Python BPyModifier_Type structure definition:                                */
/*****************************************************************************/
PyTypeObject BPyModifier_Type = {
	PyObject_HEAD_INIT( NULL )  /* required py macro */
	0,                          /* ob_size */
	/*  For printing, in format "<module>.<name>" */
	"Blender Modifier",         /* char *tp_name; */
	sizeof( BPyModifierObject ),     /* int tp_basicsize; */
  ...
  /*** Attribute descriptor and subclassing stuff ***/
	BPyModifier_methods,       /* struct PyMethodDef *tp_methods; */
	NULL,                       /* struct PyMemberDef *tp_members; */
	BPyModifier_getset,		/* struct PyGetSetDef *tp_getset; */
...
/*****************************************************************************/
/* Python BPyModifierObject methods:                                              */
/*****************************************************************************/
...
static int Modifier_setName( BPyModifierObject * self, PyObject * attr )
{
...
static constDefinition modifierTypes;
static PyObject *Modifier_getType( BPyModifierObject * self )
{
	MODIFIER_DEL_CHECK_PY(self);
	return PyConst_NewInt( &modifierTypes, self->md->type );
}

static PyObject *subsurf_getter( BPyModifierObject * self, int type )
{
...
static int subsurf_setter( BPyModifierObject * self, int type,
		PyObject *value )
{
	SubsurfModifierData *md = (SubsurfModifierData *)(self->md);
...
static PyObject *armature_getter( BPyModifierObject * self, int type )
{
...
static int armature_setter( BPyModifierObject *self, int type, PyObject *value )
{
	ArmatureModifierData *md = (ArmatureModifierData *)(self->md);
...
static PyObject *lattice_getter( BPyModifierObject * self, int type )
{
...
static int lattice_setter( BPyModifierObject *self, int type, PyObject *value )
{
	LatticeModifierData *md = (LatticeModifierData *)(self->md);
...
static PyObject *curve_getter( BPyModifierObject * self, int type )
{
...
static int curve_setter( BPyModifierObject *self, int type, PyObject *value )
{
	CurveModifierData *md = (CurveModifierData *)(self->md);
...
static PyObject *build_getter( BPyModifierObject * self, int type )
{
...
static int build_setter( BPyModifierObject *self, int type, PyObject *value )
{
	BuildModifierData *md = (BuildModifierData *)(self->md);
...
static PyObject *mirror_getter( BPyModifierObject * self, int type )
{
...
static int mirror_setter( BPyModifierObject *self, int type, PyObject *value )
{
	MirrorModifierData *md = (MirrorModifierData *)(self->md);
...
static PyObject *decimate_getter( BPyModifierObject * self, int type )
{
...
static int decimate_setter( BPyModifierObject *self, int type, PyObject *value )
{
	DecimateModifierData *md = (DecimateModifierData *)(self->md);
...
static PyObject *smooth_getter( BPyModifierObject * self, int type )
{
...
static int smooth_setter( BPyModifierObject *self, int type, PyObject *value )
{
	SmoothModifierData *md = (SmoothModifierData *)(self->md);
...
static PyObject *cast_getter( BPyModifierObject * self, int type )
{
...
static int cast_setter( BPyModifierObject *self, int type, PyObject *value )
{
	CastModifierData *md = (CastModifierData *)(self->md);
	...
	case EXPP_MOD_OBJECT: {
		...
		if (value == Py_None) {
			md->object = NULL;
		} else if (BPyObject_Check( value )) {
			ob_new = ((( BPyObject * )value)->object);
			md->object = ob_new;
		} else {
			return EXPP_ReturnIntError( PyExc_TypeError,
...
static PyObject *wave_getter( BPyModifierObject * self, int type )
{
...
static int wave_setter( BPyModifierObject *self, int type, PyObject *value )
{
	WaveModifierData *md = (WaveModifierData *)(self->md);
...
static PyObject *array_getter( BPyModifierObject * self, int type )
{
	...
	if( type == EXPP_MOD_OBJECT_OFFSET )
		...
		return Vector_CreatePyObject( md->offset, 3, (PyObject *)NULL );
	else if( type == EXPP_MOD_SCALE_VEC)
		return Vector_CreatePyObject( md->scale, 3, (PyObject *)NULL );
	
	return EXPP_ReturnPyObjError( PyExc_KeyError, "key not found" );
}

static int array_setter( BPyModifierObject *self, int type, PyObject *value )
{
	ArrayModifierData *md = (ArrayModifierData *)(self->md);
	switch( type ) {
	...
	case EXPP_MOD_OFFSET_VEC:
		return EXPP_setVec3Clamped( (BPyVectorObject *)value, md->offset, -10000.0, 10000.0 );
	case EXPP_MOD_SCALE_VEC:
		return EXPP_setVec3Clamped( (BPyVectorObject *)value, md->scale, -10000.0, 10000.0 );
	default:
		return EXPP_ReturnIntError( PyExc_KeyError, "key not found" );
	}
}

static PyObject *boolean_getter( BPyModifierObject * self, int type )
{
...
static int boolean_setter( BPyModifierObject *self, int type, PyObject *value )
{
	BooleanModifierData *md = (BooleanModifierData *)(self->md);
...
static PyObject *edgesplit_getter( BPyModifierObject * self, int type )
{
...
static int edgesplit_setter( BPyModifierObject *self, int type, PyObject *value )
{
	EdgeSplitModifierData *md = (EdgeSplitModifierData *)(self->md);
...
static PyObject *displace_getter( BPyModifierObject * self, int type )
{
...
static int displace_setter( BPyModifierObject *self, int type, PyObject *value )
{
	DisplaceModifierData *md = (DisplaceModifierData *)(self->md);
...
/* static PyObject *uvproject_getter( BPyModifierObject * self, int type )
{
	DisplaceModifierData *md = (DisplaceModifierData *)(self->md);
...
static int uvproject_setter( BPyModifierObject *self, int type, PyObject *value )
{
	DisplaceModifierData *md = (DisplaceModifierData *)(self->md);
...
/* Description: This is a callback function for the BPyModifierObject type. It    */
...
/* Three Python BPyModifier_Type helper functions needed by the Object module: */

/*****************************************************************************/
/* Function:    Modifier_CreatePyObject                                      */
/* Description: This function will create a new BPyModifierObject from an         */
/*              existing Blender modifier structure.                         */
/*****************************************************************************/
PyObject *Modifier_CreatePyObject( Object *ob, ModifierData * md )
{
	BPyModifierObject *pymod;
	pymod = ( BPyModifierObject * ) PyObject_NEW( BPyModifierObject, &BPyModifier_Type );
	if( !pymod )
		return EXPP_ReturnPyObjError( PyExc_MemoryError,
					      "couldn't create BPyModifierObject object" );
	pymod->md = md;
	pymod->object = ob;
...
static PyObject *ModSeq_getIter( BPyModSeqObject * self )
{
	if (!self->iter) {
...
static PyObject *ModSeq_nextIter( BPyModSeqObject * self )
{
...
static int ModSeq_length( BPyModSeqObject * self )
{
...
static PyObject *ModSeq_item( BPyModSeqObject * self, int i )
{
...
/*****************************************************************************/
/* Python BPyModSeqObject sequence table:                                      */
/*****************************************************************************/
...
static ModifierData *locate_modifier( BPyModSeqObject *self, PyObject * args )
{
	BPyModifierObject *pyobj;
	ModifierData *md;

	/* check that argument is a modifier */
	if( !PyArg_ParseTuple( args, "O!", &BPyModifier_Type, &pyobj ) )
...
static PyObject *ModSeq_append( BPyModSeqObject *self, PyObject *args )
{
	int type;
...
static PyObject *ModSeq_remove( BPyModSeqObject *self, PyObject *args )
{
	ModifierData *md = locate_modifier( self, args );
	BPyModifierObject *py_obj;
	...
	py_obj = ( BPyModifierObject * )PyTuple_GET_ITEM( args, 0 );
	py_obj->md = NULL;
...
static PyObject *ModSeq_moveUp( BPyModSeqObject * self, PyObject * args )
{
	ModifierData *md = locate_modifier( self, args );
...
static PyObject *ModSeq_moveDown( BPyModSeqObject * self, PyObject *args )
{
	ModifierData *md = locate_modifier( self, args );
...
/*****************************************************************************/
/* Python BPyModSeqObject methods table:                                       */
/*****************************************************************************/
static PyMethodDef BPyModSeq_methods[] = {
	/* name, method, flags, doc */
...
/*****************************************************************************/
/* Python BPyModSeq_Type structure definition:                               */
/*****************************************************************************/
PyTypeObject BPyModSeq_Type = {
	PyObject_HEAD_INIT( NULL )  /* required py macro */
	0,                          /* ob_size */
	/*  For printing, in format "<module>.<name>" */
	"Blender.Modifiers",        /* char *tp_name; */
	sizeof( BPyModSeqObject ),       /* int tp_basicsize; */
	0,                          /* tp_itemsize;  For allocation */
  ...
  /*** Attribute descriptor and subclassing stuff ***/
	BPyModSeq_methods,         /* struct PyMethodDef *tp_methods; */
	NULL,                       /* struct PyMemberDef *tp_members; */
...
/* Description: This function will create a new BPyModSeqObject from an        */
/*              existing  ListBase structure.                                */
/*****************************************************************************/
PyObject *ModSeq_CreatePyObject( Object *ob, ModifierData *iter )
{
	BPyModSeqObject *pymod;
	pymod = ( BPyModSeqObject * ) PyObject_NEW( BPyModSeqObject, &BPyModSeq_Type );
	if( !pymod )
		return EXPP_ReturnPyObjError( PyExc_MemoryError,
				"couldn't create BPyModSeqObject object" );
	pymod->object = ob;
	pymod->iter = iter;
	return ( PyObject * ) pymod;
}
...
static constIdents modifierTypesIdents[] = {
	{"SUBSURF",   	{(int)eModifierType_Subsurf}},
	{"ARMATURE",	{(int)eModifierType_Armature}},
	{"LATTICE",		{(int)eModifierType_Lattice}},
	{"CURVE",		{(int)eModifierType_Curve}},
	{"BUILD",		{(int)eModifierType_Build}},
	{"MIRROR",		{(int)eModifierType_Mirror}},
	{"DECIMATE",	{(int)eModifierType_Decimate}},
	{"WAVE",		{(int)eModifierType_Wave}},
	{"BOOLEAN",		{(int)eModifierType_Boolean}},
	{"ARRAY",		{(int)eModifierType_Array}},
	{"EDGESPLIT",	{(int)eModifierType_EdgeSplit}},
	{"SMOOTH",		{(int)eModifierType_Smooth}},
	{"CAST",		{(int)eModifierType_Cast}},
};
...
static constDefinition modifierTypes = {
	EXPP_CONST_INT, "Types",
		sizeof(modifierTypesIdents)/sizeof(constIdents), modifierTypesIdents
};

/*		
static PyObject *M_Modifier_SettingsDict( void )
{*/
	/* TODO - convert to attributes */
...
PyObject *ModifierType_Init( void )
{
	...
	if( BPyModifier_Type.tp_dict == NULL ) {
...
{
	PyType_Ready( &BPyModSeq_Type );
	return (PyObject *) &BPyModSeq_Type;
}
