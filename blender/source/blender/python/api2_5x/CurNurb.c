/*
 * $Id: CurNurb.c 12802 2007-12-06 00:01:46Z campbellbarton $
...
static int CurNurb_setMatIndex( BPyCurNurbObject * self, PyObject * args );
static PyObject *CurNurb_getMatIndex( BPyCurNurbObject * self );
static PyObject *CurNurb_getFlagU( BPyCurNurbObject * self );

static int CurNurb_setFlagU( BPyCurNurbObject * self, PyObject * args );
static PyObject *CurNurb_getFlagV( BPyCurNurbObject * self );

static int CurNurb_setFlagV( BPyCurNurbObject * self, PyObject * args );
static PyObject *CurNurb_getType( BPyCurNurbObject * self );

static int CurNurb_setType( BPyCurNurbObject * self, PyObject * args );
static PyObject *CurNurb_getKnotsU( BPyCurNurbObject * self );
static PyObject *CurNurb_getKnotsV( BPyCurNurbObject * self );
static PyObject *CurNurb_getPoints( BPyCurNurbObject * self );
/* static PyObject* CurNurb_setXXX( BPyCurNurbObject* self, PyObject* args ); */
static int CurNurb_setPoint( BPyCurNurbObject * self, int index, PyObject * ob );
static int CurNurb_length( PyInstanceObject * inst );
static PyObject *CurNurb_getIter( BPyCurNurbObject * self );
static PyObject *CurNurb_iterNext( BPyCurNurbObject * self );
PyObject *CurNurb_append( BPyCurNurbObject * self, PyObject * args );

static PyObject *CurNurb_isNurb( BPyCurNurbObject * self );
static PyObject *CurNurb_isCyclic( BPyCurNurbObject * self );
static PyObject *CurNurb_dump( BPyCurNurbObject * self );
static PyObject *CurNurb_switchDirection( BPyCurNurbObject * self );
static PyObject *CurNurb_recalc( BPyCurNurbObject * self );
static PyObject *CurNurb_getFlagBits( BPyCurNurbObject * self, void *type );
static int CurNurb_setFlagBits( BPyCurNurbObject * self, PyObject *value, void *type );
char M_CurNurb_doc[] = "CurNurb";


/*	
  BPyCurNurb_Type callback function prototypes:                          
*/

static int CurNurb_compare( BPyCurNurbObject * a, BPyCurNurbObject * b );
static PyObject *CurNurb_repr( BPyCurNurbObject * self );
...
static PyMethodDef BPyCurNurb_methods[] = {
...
static PyGetSetDef BPyCurNurb_getset[] = {
	{"mat_index",
...
PyTypeObject BPyCurNurb_Type = {
	PyObject_HEAD_INIT( NULL ) /* required py macro */
	0,	/* ob_size */
	/*  For printing, in format "<module>.<name>" */
	"CurNurb",		/* char *tp_name; */
	sizeof( BPyCurNurb_Type ),	/* int tp_basicsize, */
  ...
  /*** Attribute descriptor and subclassing stuff ***/
	BPyCurNurb_methods,	/*    struct PyMethodDef *tp_methods; */
	0,			/*    struct PyMemberDef *tp_members; */
	BPyCurNurb_getset,			/*    struct PyGetSetDef *tp_getset; */
...
/*
  factory method to create a BPyCurNurbObject from a Blender Nurb
*/

PyObject *CurNurb_CreatePyObject( Nurb * blen_nurb )
{
	BPyCurNurbObject *pyNurb;

	pyNurb = ( BPyCurNurbObject * ) PyObject_NEW( BPyCurNurbObject, &BPyCurNurb_Type );

	if( !pyNurb )
		return EXPP_ReturnPyObjError( PyExc_MemoryError,
					      "could not create BPyCurNurbObject PyObject" );
...
static int CurNurb_setFlagBits( BPyCurNurbObject * self, PyObject *value,
									void *type )
{
...
static int CurNurb_length( PyInstanceObject * inst )
{
	...
	if( BPyCurNurb_Check( ( PyObject * ) inst ) ) {
		nurb = ( ( BPyCurNurbObject * ) inst )->nurb;
		len = nurb->pntsu;
		return len;
	}

	return EXPP_ReturnIntError( PyExc_RuntimeError,
				    "arg is not a BPyCurNurbObject" );
}
...
PyObject *CurNurb_getPoint( BPyCurNurbObject * self, int index )
{
	Nurb *myNurb;
 ...
 * it is called via the [] = operator, not as a usual instance method.
 */
static int CurNurb_setPoint( BPyCurNurbObject * self, int index, PyObject * pyOb )
{
	Nurb *nurb = self->nurb;
	int size;
...
PyObject *CurNurb_dump( BPyCurNurbObject * self )
{
	BPoint *bp = NULL;
	BezTriple *bezt = NULL;
	Nurb *nurb = self->nurb;
...
PyObject *CurNurb_switchDirection( BPyCurNurbObject * self )
{
	if( !self->nurb )
		return EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"no Nurb in this CurNurb");
