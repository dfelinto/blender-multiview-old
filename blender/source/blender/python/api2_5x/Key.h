/*
 * $Id: Key.h 11446 2007-07-31 16:11:32Z campbellbarton $
 *
...
extern PyTypeObject BPyKey_Type;
extern PyTypeObject BPyKeyBlock_Type;
...
typedef struct {
	PyObject_HEAD		/* required python macro   */
	KeyBlock * keyblock; /* make sure this is the unique part so the first pointer can be used to compare */
	Key *key;
	/* Object *object;*/		/* for vertex grouping info, since it's stored on the object */
} BPyKeyBlockObject;
