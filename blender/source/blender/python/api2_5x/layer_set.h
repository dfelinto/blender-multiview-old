...
#ifndef EXPP_LAYER_SET_H
#define EXPP_LAYER_SET_H
...
typedef struct {
	PySetObject set;
	BPyGenericLibObject * genlib; /* this is the BPyGenericLibObject the data uses  */
} BPyLayerSetObject;

extern PyTypeObject BPyLayerSet_Type;	/* The Material PyType Object */

#define BPyLayerSet_Check(v) PyObject_TypeCheck((v, &BPyLayerSet_Type)	/* for type checking */
