/* 
 * $Id: NLA.c 12898 2007-12-15 21:44:40Z campbellbarton $
 *
...
/*****************************************************************************/
static PyObject *V24_M_NLA_NewAction( PyObject * self, PyObject * args );
static PyObject *V24_M_NLA_CopyAction( PyObject * self, PyObject * args );
static PyObject *V24_M_NLA_GetActions( PyObject * self );
...
char V24_M_NLA_NewAction_doc[] =
	"(name) - Create new action for linking to an object.";
char V24_M_NLA_CopyAction_doc[] = "(name) - Copy action and return copy.";
char V24_M_NLA_GetActions_doc[] = "(name) - Returns a dictionary of actions.";
...
struct PyMethodDef V24_M_NLA_methods[] = {
	...
	{"CopyAction", ( PyCFunction ) V24_M_NLA_CopyAction, METH_VARARGS,
	 V24_M_NLA_CopyAction_doc},
	{"GetActions", ( PyCFunction ) V24_M_NLA_GetActions, METH_NOARGS,
	 V24_M_NLA_GetActions_doc},
	{NULL, NULL, 0, NULL}
};
/*****************************************************************************/
/* Python V24_BPy_Action methods declarations:				*/
/*****************************************************************************/
static PyObject *V24_Action_setActive( V24_BPy_Action * self, PyObject * args );
static PyObject *V24_Action_getFrameNumbers(V24_BPy_Action *self);
static PyObject *V24_Action_getChannelIpo( V24_BPy_Action * self, PyObject * value );
static PyObject *V24_Action_getChannelNames( V24_BPy_Action * self );
static PyObject *V24_Action_renameChannel( V24_BPy_Action * self, PyObject * args );
static PyObject *V24_Action_verifyChannel( V24_BPy_Action * self, PyObject * value );
static PyObject *V24_Action_removeChannel( V24_BPy_Action * self, PyObject * value );
static PyObject *V24_Action_getAllChannelIpos( V24_BPy_Action * self );

/*****************************************************************************/
/* Python V24_BPy_Action methods table:					 */
/*****************************************************************************/
static PyMethodDef V24_BPy_Action_methods[] = {
	...
	{"setName", ( PyCFunction ) V24_GenericLib_setName_with_method, METH_VARARGS,
	 "(str) - rename Action"},
	{"setActive", ( PyCFunction ) V24_Action_setActive, METH_VARARGS,
	 "(str) -set this action as the active action for an object"},
	{"getFrameNumbers", (PyCFunction) V24_Action_getFrameNumbers, METH_NOARGS,
	"() - get the frame numbers at which keys have been inserted"},
	{"getChannelIpo", ( PyCFunction ) V24_Action_getChannelIpo, METH_O,
	 "(str) -get the Ipo from a named action channel in this action"},
	{"getChannelNames", ( PyCFunction ) V24_Action_getChannelNames, METH_NOARGS,
	 "() -get the channel names for this action"},
	 {"renameChannel", ( PyCFunction ) V24_Action_renameChannel, METH_VARARGS,
		 "(from, to) -rename the channel from string to string"},
	{"verifyChannel", ( PyCFunction ) V24_Action_verifyChannel, METH_O,
	 "(str) -verify the channel in this action"},
	{"removeChannel", ( PyCFunction ) V24_Action_removeChannel, METH_O,
	 "(str) -remove the channel from the action"},
	{"getAllChannelIpos", ( PyCFunction ) V24_Action_getAllChannelIpos,
	 METH_NOARGS,
...
/*****************************************************************************/
static int V24_Action_compare( V24_BPy_Action * a, V24_BPy_Action * b );
static PyObject *V24_Action_repr( V24_BPy_Action * bone );

/*-------------------------------------------------------------------------*/
static PyObject *V24_M_NLA_NewAction( PyObject * self_unused, PyObject * args )
{
	char *name_str = "DefaultAction";
	V24_BPy_Action *py_action = NULL;	/* for Action Data object wrapper in Python */
	bAction *bl_action = NULL;	/* for actual Action Data we create in Blender */

	if( !PyArg_ParseTuple( args, "|s", &name_str ) ) {
		V24_EXPP_ReturnPyObjError( PyExc_AttributeError,
	...
	if( bl_action )
		py_action =
			( V24_BPy_Action * ) PyObject_NEW( V24_BPy_Action,
						       &V24_Action_Type );
	else {
		V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				       "couldn't create Action Data in Blender" );
		return NULL;
	}

	if( py_action == NULL ) {
		V24_EXPP_ReturnPyObjError( PyExc_MemoryError,
...
static PyObject *V24_M_NLA_CopyAction( PyObject * self_unused, PyObject * args )
{
	V24_BPy_Action *py_action = NULL;
	bAction *copyAction = NULL;

	if( !PyArg_ParseTuple( args, "O!", &V24_Action_Type, &py_action ) ) {
		V24_EXPP_ReturnPyObjError( PyExc_AttributeError,
				       "expected python action type" );
		return NULL;
	}
	copyAction = copy_action( py_action->action );
	return V24_Action_CreatePyObject( copyAction );
}

static PyObject *V24_M_NLA_GetActions( PyObject * self_unused )
{
	PyObject *dict = PyDict_New(  );
	bAction *action = NULL;

	for( action = G.main->action.first; action; action = action->id.next ) {
		PyObject *py_action = V24_Action_CreatePyObject( action );
		if( py_action ) {
...
static PyObject *V24_Action_getFrameNumbers(V24_BPy_Action *self)
{
	...
	PyList_Sort(py_list);
	return V24_EXPP_incr_ret(py_list);
}
...
static PyObject *V24_Action_getChannelIpo( V24_BPy_Action * self, PyObject * value )
{
	...
	return V24_Ipo_CreatePyObject( chan->ipo );
}
...
static PyObject *V24_Action_getAllChannelIpos( V24_BPy_Action * self )
{
	...
	for( chan = self->action->chanbase.first; chan; chan = chan->next ) {
		PyObject *ipo_attr;
	   	if( chan->ipo )
			ipo_attr = V24_Ipo_CreatePyObject( chan->ipo );
		else {
			ipo_attr = Py_None;
			Py_INCREF( ipo_attr );
		}
		if( ipo_attr ) {
			...
			if( PyDict_SetItemString( dict, chan->name, ipo_attr )
				...
				return V24_EXPP_ReturnPyObjError
					( PyExc_RuntimeError,
					  "V24_Action_getAllChannelIpos: couldn't set dict item" );
			}
			Py_DECREF( ipo_attr );
		} else {
			Py_DECREF( dict );
			return ( V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
							"V24_Action_getAllChannelIpos: could not create Ipo object" ) );
		}
	}
	return dict;
}
...
/*----------------------------------------------------------------------*/
static PyObject *V24_Action_repr( V24_BPy_Action * self )
{
	if( self->action )
...
/*----------------------------------------------------------------------*/
PyObject *V24_Action_CreatePyObject( struct bAction * act )
{
	V24_BPy_Action *blen_action;

	if(!act) Py_RETURN_NONE;

	blen_action =
		( V24_BPy_Action * ) PyObject_NEW( V24_BPy_Action, &V24_Action_Type );
...
/*----------------------------------------------------------------------*/
struct bAction *V24_Action_FromPyObject( PyObject * py_obj )
{
	V24_BPy_Action *blen_obj;

	blen_obj = ( V24_BPy_Action * ) py_obj;
...
/*****************************************************************************/
PyTypeObject V24_Action_Type = {
	PyObject_HEAD_INIT( NULL ) 
	0,	/* ob_size */
	"Blender Action",	/* tp_name */
	sizeof( V24_BPy_Action ),	/* tp_basicsize */
	0,			/* tp_itemsize */
	/* methods */
	NULL,	/* tp_dealloc */
	NULL,	/* tp_print */
	NULL,	/* tp_getattr */
	NULL,	/* tp_setattr */
	( cmpfunc ) V24_Action_compare,		/* tp_compare */
	( reprfunc ) V24_Action_repr,	/* tp_repr */
  ...
  /*** Attribute descriptor and subclassing stuff ***/
	V24_BPy_Action_methods,           /* struct PyMethodDef *tp_methods; */
	NULL,                       /* struct PyMemberDef *tp_members; */
	V24_BPy_Action_getseters,         /* struct PyGetSetDef *tp_getset; */
...
/*****************************************************************************/
/* Python V24_BPy_ActionStrip attributes:                                        */
/*****************************************************************************/
...
static PyObject *V24_ActionStrip_getAction( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
	
	return V24_Action_CreatePyObject( self->strip->act );
}
...
static PyObject *V24_ActionStrip_getStripStart( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setStripStart( V24_BPy_ActionStrip * self, PyObject * value )
{
	int retval;
	...
	retval = V24_EXPP_setFloatClamped( value, &self->strip->start,
...
static PyObject *V24_ActionStrip_getStripEnd( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setStripEnd( V24_BPy_ActionStrip * self, PyObject * value )
{
	int retval;
	...
	retval = V24_EXPP_setFloatClamped( value, &self->strip->end,
...
static PyObject *V24_ActionStrip_getActionStart( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setActionStart( V24_BPy_ActionStrip * self, PyObject * value )
{
	if( !self->strip )
		return V24_EXPP_ReturnIntError( PyExc_RuntimeError,
				"This strip has been removed!" );

	return V24_EXPP_setFloatClamped( value, &self->strip->actstart,
...
static PyObject *V24_ActionStrip_getActionEnd( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setActionEnd( V24_BPy_ActionStrip * self, PyObject * value )
{
	if( !self->strip )
		return V24_EXPP_ReturnIntError( PyExc_RuntimeError,
				"This strip has been removed!" );

	return V24_EXPP_setFloatClamped( value, &self->strip->actend,
...
static PyObject *V24_ActionStrip_getRepeat( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setRepeat( V24_BPy_ActionStrip * self, PyObject * value )
{
	if( !self->strip )
		return V24_EXPP_ReturnIntError( PyExc_RuntimeError,
				"This strip has been removed!" );

	return V24_EXPP_setFloatClamped( value, &self->strip->repeat,
			0.001f, 1000.0f );
}
...
static PyObject *V24_ActionStrip_getBlendIn( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setBlendIn( V24_BPy_ActionStrip * self, PyObject * value )
{
	if( !self->strip )
		return V24_EXPP_ReturnIntError( PyExc_RuntimeError,
				"This strip has been removed!" );

	return V24_EXPP_setFloatClamped( value, &self->strip->blendin,
...
static PyObject *V24_ActionStrip_getBlendOut( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setBlendOut( V24_BPy_ActionStrip * self, PyObject * value )
{
	if( !self->strip )
		return V24_EXPP_ReturnIntError( PyExc_RuntimeError,
				"This strip has been removed!" );

	return V24_EXPP_setFloatClamped( value, &self->strip->blendout,
			0.0, self->strip->end - self->strip->start );
}
...
static PyObject *V24_ActionStrip_getBlendMode( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setBlendMode( V24_BPy_ActionStrip * self, PyObject * value )
{
	if( !self->strip )
		return V24_EXPP_ReturnIntError( PyExc_RuntimeError,
				"This strip has been removed!" );

	return V24_EXPP_setIValueRange( value, &self->strip->mode,
...
static PyObject *V24_ActionStrip_getFlag( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setFlag( V24_BPy_ActionStrip * self, PyObject * arg )
{
...
static PyObject *V24_ActionStrip_getStrideAxis( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setStrideAxis( V24_BPy_ActionStrip * self, PyObject * value )
{
	if( !self->strip )
		return V24_EXPP_ReturnIntError( PyExc_RuntimeError,
				"This strip has been removed!" );

	return V24_EXPP_setIValueRange( value, &self->strip->stride_axis,
...
static PyObject *V24_ActionStrip_getStrideLength( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static int V24_ActionStrip_setStrideLength( V24_BPy_ActionStrip * self, PyObject * value )
{
	if( !self->strip )
		return V24_EXPP_ReturnIntError( PyExc_RuntimeError,
				"This strip has been removed!" );

	return V24_EXPP_setFloatClamped( value, &self->strip->stridelen,
			0.0001f, 1000.0 );
}
...
static PyObject *V24_ActionStrip_getStrideBone( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
static PyObject *V24_ActionStrip_getGroupTarget( V24_BPy_ActionStrip * self )
{
	if( !self->strip )
		return V24_EXPP_ReturnPyObjError( PyExc_RuntimeError,
				"This strip has been removed!" );
	...
	if (self->strip->object) {
		return V24_Object_CreatePyObject( self->strip->object );
	} else {
		Py_RETURN_NONE;
	}
}
...
static int V24_ActionStrip_setStrideBone( V24_BPy_ActionStrip * self, PyObject * attr )
{
...
static int V24_ActionStrip_setGroupTarget( V24_BPy_ActionStrip * self, PyObject * args )
{
	if( !self->strip )
		return V24_EXPP_ReturnIntError( PyExc_RuntimeError,
				"This strip has been removed!" );
...
/*****************************************************************************/
static PyGetSetDef V24_BPy_ActionStrip_getseters[] = {
	{"action",
	(getter)V24_ActionStrip_getAction, (setter)NULL,
	 "Action associated with the strip", NULL},
	{"stripStart",
	(getter)V24_ActionStrip_getStripStart, (setter)V24_ActionStrip_setStripStart,
	 "Starting frame of the strip", NULL},
	{"stripEnd",
	(getter)V24_ActionStrip_getStripEnd, (setter)V24_ActionStrip_setStripEnd,
	 "Ending frame of the strip", NULL},
	{"actionStart",
	(getter)V24_ActionStrip_getActionStart, (setter)V24_ActionStrip_setActionStart,
	 "Starting frame of the action", NULL},
	{"actionEnd",
	(getter)V24_ActionStrip_getActionEnd, (setter)V24_ActionStrip_setActionEnd,
	 "Ending frame of the action", NULL},
	{"repeat",
	(getter)V24_ActionStrip_getRepeat, (setter)V24_ActionStrip_setRepeat,
	 "The number of times to repeat the action range", NULL},
	{"blendIn",
	(getter)V24_ActionStrip_getBlendIn, (setter)V24_ActionStrip_setBlendIn,
	 "Number of frames of motion blending", NULL},
	{"blendOut",
	(getter)V24_ActionStrip_getBlendOut, (setter)V24_ActionStrip_setBlendOut,
	 "Number of frames of ease-out", NULL},
	{"mode",
	(getter)V24_ActionStrip_getBlendMode, (setter)V24_ActionStrip_setBlendMode,
	 "Setting of blending mode", NULL},
	{"flag",
	(getter)V24_ActionStrip_getFlag, (setter)V24_ActionStrip_setFlag,
	 "Setting of blending flags", NULL},
	{"strideAxis",
	(getter)V24_ActionStrip_getStrideAxis, (setter)V24_ActionStrip_setStrideAxis,
	 "Dominant axis for stride bone", NULL},
	{"strideLength",
	(getter)V24_ActionStrip_getStrideLength, (setter)V24_ActionStrip_setStrideLength,
  	 "Distance covered by one complete cycle of the action", NULL},
	{"strideBone",
	(getter)V24_ActionStrip_getStrideBone, (setter)V24_ActionStrip_setStrideBone,
  	 "Name of Bone used for stride", NULL},
	{"groupTarget",
	(getter)V24_ActionStrip_getGroupTarget, (setter)V24_ActionStrip_setGroupTarget,
	 "Name of target armature within group", NULL},	
	{NULL,NULL,NULL,NULL,NULL}  /* Sentinel */
};

/*****************************************************************************/
/* Python V24_BPy_ActionStrip methods:                                           */
/*****************************************************************************/
...
static PyObject *V24_ActionStrip_resetLimits( V24_BPy_ActionStrip *self )
{
...
static PyObject *V24_ActionStrip_resetStripSize( V24_BPy_ActionStrip *self )
{
	float mapping;
	bActionStrip *strip = self->strip;
...
static PyObject *V24_ActionStrip_snapToFrame( V24_BPy_ActionStrip *self )
{
	bActionStrip *strip = self->strip;
...
/*****************************************************************************/
/* Python V24_BPy_ActionStrip methods table:                                    */
/*****************************************************************************/
static PyMethodDef V24_BPy_ActionStrip_methods[] = {
	/* name, method, flags, doc */
	{"resetActionLimits", ( PyCFunction ) V24_ActionStrip_resetLimits, METH_NOARGS,
	 "Restores the values of ActionStart and ActionEnd to their defaults"},
	{"resetStripSize", ( PyCFunction ) V24_ActionStrip_resetStripSize, METH_NOARGS,
	 "Resets the Action Strip size to its creation values"},
	{"snapToFrame", ( PyCFunction ) V24_ActionStrip_snapToFrame, METH_NOARGS,
	 "Snaps the ends of the action strip to the nearest whole numbered frame"},
	{NULL, NULL, 0, NULL}
};

/*****************************************************************************/
/* Python V24_ActionStrip_Type structure definition:                            */
/*****************************************************************************/
PyTypeObject V24_ActionStrip_Type = {
	PyObject_HEAD_INIT( NULL )  /* required py macro */
	0,                          /* ob_size */
	/*  For printing, in format "<module>.<name>" */
	"Blender.ActionStrip",     /* char *tp_name; */
	sizeof( V24_BPy_ActionStrip ), /* int tp_basicsize; */
  ...
  /*** Attribute descriptor and subclassing stuff ***/
	V24_BPy_ActionStrip_methods,    /* struct PyMethodDef *tp_methods; */
	NULL,                       /* struct PyMemberDef *tp_members; */
	V24_BPy_ActionStrip_getseters,  /* struct PyGetSetDef *tp_getset; */
	NULL,                       /* struct _typeobject *tp_base; */
	NULL,                       /* PyObject *tp_dict; */
	NULL,                       /* descrgetfunc tp_descr_get; */
	NULL,                       /* descrsetfunc tp_descr_set; */
...
static PyObject *V24_M_ActionStrip_FlagsDict( void )
{
	PyObject *S = V24_PyConstant_New(  );
	
	if( S ) {
		V24_BPy_constant *d = ( V24_BPy_constant * ) S;
		V24_PyConstant_Insert( d, "SELECT",
				PyInt_FromLong( ACTSTRIP_SELECT ) );
		V24_PyConstant_Insert( d, "STRIDE_PATH",
				PyInt_FromLong( ACTSTRIP_USESTRIDE ) );
		V24_PyConstant_Insert( d, "HOLD",
				PyInt_FromLong( ACTSTRIP_HOLDLASTFRAME ) );
		V24_PyConstant_Insert( d, "ACTIVE",
				PyInt_FromLong( ACTSTRIP_ACTIVE ) );
		V24_PyConstant_Insert( d, "LOCK_ACTION",
				PyInt_FromLong( ACTSTRIP_LOCK_ACTION ) );
	}
	return S;
}

static PyObject *V24_M_ActionStrip_AxisDict( void )
{
	PyObject *S = V24_PyConstant_New(  );
	
	if( S ) {
		V24_BPy_constant *d = ( V24_BPy_constant * ) S;
		V24_PyConstant_Insert( d, "STRIDEAXIS_X",
				PyInt_FromLong( ACTSTRIP_STRIDEAXIS_X ) );
		V24_PyConstant_Insert( d, "STRIDEAXIS_Y",
				PyInt_FromLong( ACTSTRIP_STRIDEAXIS_Y ) );
		V24_PyConstant_Insert( d, "STRIDEAXIS_Z",
				PyInt_FromLong( ACTSTRIP_STRIDEAXIS_Z ) );
	}
	return S;
}

static PyObject *V24_M_ActionStrip_ModeDict( void )
{
	PyObject *S = V24_PyConstant_New(  );
	
	if( S ) {
		V24_BPy_constant *d = ( V24_BPy_constant * ) S;
		V24_PyConstant_Insert( d, "MODE_ADD",
...
{
	V24_BPy_ActionStrip *pyobj;
	pyobj = ( V24_BPy_ActionStrip * ) PyObject_NEW( V24_BPy_ActionStrip,
			&V24_ActionStrip_Type );
	if( !pyobj )
		return V24_EXPP_ReturnPyObjError( PyExc_MemoryError,
					      "couldn't create V24_BPy_ActionStrip object" );
	pyobj->strip = strip;
...
static PyObject *V24_ActionStrips_getIter( V24_BPy_ActionStrips * self )
{
...
static PyObject *V24_ActionStrips_nextIter( V24_BPy_ActionStrips * self )
{
...
static int V24_ActionStrips_length( V24_BPy_ActionStrips * self )
{
...
static PyObject *V24_ActionStrips_item( V24_BPy_ActionStrips * self, int i )
{
	bActionStrip *strip = NULL;

	/* if index is negative, start counting from the end of the list */
	if( i < 0 )
		i += V24_ActionStrips_length( self );
...
/*****************************************************************************/
/* Python V24_BPy_ActionStrips sequence table:                                  */
/*****************************************************************************/
static PySequenceMethods V24_ActionStrips_as_sequence = {
	( inquiry ) V24_ActionStrips_length,	/* sq_length */
	( binaryfunc ) 0,	/* sq_concat */
	( intargfunc ) 0,	/* sq_repeat */
	( intargfunc ) V24_ActionStrips_item,	/* sq_item */
...
static bActionStrip *locate_strip( V24_BPy_ActionStrips *self, 
		PyObject *args, V24_BPy_ActionStrip **stripobj )
{
	bActionStrip *strip = NULL;
	V24_BPy_ActionStrip *pyobj;

	/* check that argument is a constraint */
	if( !PyArg_ParseTuple( args, "O!", &V24_ActionStrip_Type, &pyobj ) ) {
		V24_EXPP_ReturnPyObjError( PyExc_TypeError,
...
static PyObject *V24_ActionStrips_remove( V24_BPy_ActionStrips *self, PyObject * args )
{
	V24_BPy_ActionStrip *pyobj;
...
static PyObject *V24_ActionStrips_moveUp( V24_BPy_ActionStrips *self, PyObject * args )
{
...
static PyObject *V24_ActionStrips_moveDown( V24_BPy_ActionStrips *self, PyObject * args )
{
	bActionStrip *strip = locate_strip( self, args, NULL );
...
static PyObject *V24_ActionStrips_append( V24_BPy_ActionStrips *self, PyObject * args )
{
	V24_BPy_Action *pyobj;
	Object *ob;
	bActionStrip *strip;
	bAction *act;

	/* check that argument is an action */
	if( !PyArg_ParseTuple( args, "O!", &V24_Action_Type, &pyobj ) )
...
/*****************************************************************************/
/* Python V24_BPy_ActionStrips methods table:                                    */
/*****************************************************************************/
static PyMethodDef V24_BPy_ActionStrips_methods[] = {
	/* name, method, flags, doc */
	{"append", ( PyCFunction ) V24_ActionStrips_append, METH_VARARGS,
	 "(action) - append a new actionstrip using existing action"},
	{"remove", ( PyCFunction ) V24_ActionStrips_remove, METH_VARARGS,
	 "(strip) - remove an existing strip from this actionstrips"},
	{"moveUp", ( PyCFunction ) V24_ActionStrips_moveUp, METH_VARARGS,
	 "(strip) - move an existing strip up in the actionstrips"},
	{"moveDown", ( PyCFunction ) V24_ActionStrips_moveDown, METH_VARARGS,
	 "(strip) - move an existing strip down in the actionstrips"},
	{NULL, NULL, 0, NULL}
};

/*****************************************************************************/
/* Python V24_ActionStrips_Type structure definition:                            */
/*****************************************************************************/
PyTypeObject V24_ActionStrips_Type = {
	PyObject_HEAD_INIT( NULL )  /* required py macro */
	0,                          /* ob_size */
	/*  For printing, in format "<module>.<name>" */
	"Blender.ActionStrips",     /* char *tp_name; */
	sizeof( V24_BPy_ActionStrips ), /* int tp_basicsize; */
	0,                          /* tp_itemsize;  For allocation */
	...
	NULL,                       /* PyNumberMethods *tp_as_number; */
	&V24_ActionStrips_as_sequence,  /* PySequenceMethods *tp_as_sequence; */
	NULL,                       /* PyMappingMethods *tp_as_mapping; */
  ...
  /*** Added in release 2.2 ***/
	/*   Iterators */
	( getiterfunc )V24_ActionStrips_getIter, /* getiterfunc tp_iter; */
    ( iternextfunc )V24_ActionStrips_nextIter, /* iternextfunc tp_iternext; */

  /*** Attribute descriptor and subclassing stuff ***/
	V24_BPy_ActionStrips_methods,   /* struct PyMethodDef *tp_methods; */
	NULL,                       /* struct PyMemberDef *tp_members; */
...
PyObject *V24_ActionStrips_CreatePyObject( Object *ob )
{
	V24_BPy_ActionStrips *pyseq;
	pyseq = ( V24_BPy_ActionStrips * ) PyObject_NEW( V24_BPy_ActionStrips,
			&V24_ActionStrips_Type );
	if( !pyseq )
		return V24_EXPP_ReturnPyObjError( PyExc_MemoryError,
					      "couldn't create V24_BPy_ActionStrips object" );
	pyseq->ob = ob;
	return ( PyObject * ) pyseq;
}

/*****************************************************************************/
/* Function:    V24_NLA_Init                                                     */
/*****************************************************************************/
