/* 
 * $Id: constant.h 12898 2007-12-15 21:44:40Z campbellbarton $
 *
...
#ifndef V24_EXPP_constant_H
#define V24_EXPP_constant_H

#include <Python.h>

/*-------------------TYPE CHECKS-------------------------------*/
#define V24_BPy_Constant_Check(v) ((v)->ob_type==&constant_Type)
/*-------------------TYPEOBJECT--------------------------------*/
