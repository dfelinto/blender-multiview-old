/*
 * $Id: Armature.c 12898 2007-12-15 21:44:40Z campbellbarton $
 *
...
static PyObject* V24_BonesDict_items(V24_BPy_BonesDict *self)
{
...
static PyObject* V24_BonesDict_keys(V24_BPy_BonesDict *self)
{
	if (self->editmode_flag){
...
static PyObject* V24_BonesDict_values(V24_BPy_BonesDict *self)
{
	if (self->editmode_flag){
...
static char V24_BPy_BonesDict_doc[] = "This is an internal subobject of armature\
designed to act as a Py_Bone dictionary.";

//------------------------tp_methods
//This contains a list of all methods the object contains
static PyMethodDef V24_BPy_BonesDict_methods[] = {
	{"items", (PyCFunction) V24_BonesDict_items, METH_NOARGS, 
		"() - Returns the key:value pairs from the dictionary"},
	{"keys", (PyCFunction) V24_BonesDict_keys, METH_NOARGS, 
		"() - Returns the keys the dictionary"},
	{"values", (PyCFunction) V24_BonesDict_values, METH_NOARGS, 
		"() - Returns the values from the dictionary"},
	{NULL, NULL, 0, NULL}
};
//-----------------(internal)
static int V24_BoneMapping_Init(PyObject *dictionary, ListBase *bones){
	Bone *bone = NULL;
	...
	for (bone = bones->first; bone; bone = bone->next){
		...
		if (bone->childbase.first) 
			V24_BoneMapping_Init(dictionary, &bone->childbase);
	}
	return 0;
}
//-----------------(internal)
static int V24_EditBoneMapping_Init(PyObject *dictionary, ListBase *editbones){
	EditBone *editbone = NULL;
	PyObject *py_editbone = NULL;

	for (editbone = editbones->first; editbone; editbone = editbone->next){
		py_editbone = V24_PyEditBone_FromEditBone(editbone);
		if (!py_editbone)
			return -1;
...
static int V24_BonesDict_InitBones(V24_BPy_BonesDict *self)
{
	PyDict_Clear(self->bonesMap);
	if (V24_BoneMapping_Init(self->bonesMap, self->bones) == -1)
		return 0;
	return 1;
} 
//----------------- V24_BonesDict_InitEditBones
static int V24_BonesDict_InitEditBones(V24_BPy_BonesDict *self)
{
	PyDict_Clear(self->editbonesMap);
	if (V24_EditBoneMapping_Init(self->editbonesMap, &self->editbones) == -1)
		return 0;
	return 1;
}
//------------------------tp_repr
//This is the string representation of the object
static PyObject *V24_BonesDict_repr(V24_BPy_BonesDict *self)
{
	char str[2048];
	PyObject *key, *value;
	int pos = 0;
...
static void V24_BonesDict_dealloc(V24_BPy_BonesDict * self)
{
...
static int V24_BonesDict_len(V24_BPy_BonesDict *self)
{
	if (self->editmode_flag){
...
static PyObject *V24_BonesDict_GetItem(V24_BPy_BonesDict *self, PyObject* key)
{ 
	PyObject *value = NULL;
	...
	if(value == NULL){  /* item not found in dict. throw exception */
		...
		if (key_str) {
			return V24_EXPP_ReturnPyObjError(PyExc_KeyError, "bone key must be a string" );
		} else {
			char buffer[128];
			PyOS_snprintf( buffer, sizeof(buffer), "bone %s not found", key_str);
			return V24_EXPP_ReturnPyObjError(PyExc_KeyError, buffer );
		}
	}
...
static int V24_BonesDict_SetItem(V24_BPy_BonesDict *self, PyObject *key, PyObject *value)
{
	V24_BPy_EditBone *editbone_for_deletion;
	...
	if (value){ /* we know this must be an editbone from the above check */
		...
		editbone->dist = ((V24_BPy_EditBone*)value)->dist;
		editbone->ease1 = ((V24_BPy_EditBone*)value)->ease1;
		editbone->ease2 = ((V24_BPy_EditBone*)value)->ease2;
		editbone->flag = ((V24_BPy_EditBone*)value)->flag;
		editbone->parent = ((V24_BPy_EditBone*)value)->parent;
		editbone->rad_head = ((V24_BPy_EditBone*)value)->rad_head;
		editbone->rad_tail = ((V24_BPy_EditBone*)value)->rad_tail;
		editbone->roll = ((V24_BPy_EditBone*)value)->roll;
		editbone->segments = ((V24_BPy_EditBone*)value)->segments;
		editbone->weight = ((V24_BPy_EditBone*)value)->weight;
		editbone->xwidth = ((V24_BPy_EditBone*)value)->xwidth;
		editbone->zwidth = ((V24_BPy_EditBone*)value)->zwidth;
		VECCOPY(editbone->head, ((V24_BPy_EditBone*)value)->head);
		VECCOPY(editbone->tail, ((V24_BPy_EditBone*)value)->tail);
		editbone->layer= ((V24_BPy_EditBone*)value)->layer;
		
		//set object pointer
		((V24_BPy_EditBone*)value)->editbone = editbone;
		...
		editbone_for_deletion = (V24_BPy_EditBone*)PyDict_GetItem(self->editbonesMap, key);
...
//Mapping Protocol
static PyMappingMethods V24_BonesDict_MapMethods = {
	(inquiry) V24_BonesDict_len,					//mp_length
	(binaryfunc)V24_BonesDict_GetItem,		//mp_subscript
	(objobjargproc)V24_BonesDict_SetItem,	//mp_ass_subscript
};
//BonesDict TypeObject
PyTypeObject V24_BonesDict_Type = {
	PyObject_HEAD_INIT(NULL)			//tp_head
	0,												//tp_internal
	"BonesDict",								//tp_name
	sizeof(V24_BPy_BonesDict),					//tp_basicsize
	0,												//tp_itemsize
	(destructor)V24_BonesDict_dealloc,		//tp_dealloc
	0,												//tp_print
	0,												//tp_getattr
	0,												//tp_setattr
	0,												//tp_compare
	(reprfunc) V24_BonesDict_repr,				//tp_repr
	0,												//tp_as_number
	0,												//tp_as_sequence
	&V24_BonesDict_MapMethods,				//tp_as_mapping
	0,												//tp_hash
	0,												//tp_call
	0,												//tp_str
	0,												//tp_getattro
	...
	0,												//tp_iter
	0,												//tp_iternext
	V24_BPy_BonesDict_methods,				//tp_methods
	0,												//tp_members
	0,												//tp_getset
	0,												//tp_base
	0,												//tp_dict
...
//-----------------------V24_PyBonesDict_FromPyArmature
static PyObject *V24_PyBonesDict_FromPyArmature(V24_BPy_Armature *py_armature)
{
	V24_BPy_BonesDict *py_BonesDict = (V24_BPy_BonesDict *)PyObject_NEW( V24_BPy_BonesDict, &V24_BonesDict_Type );
	if (!py_BonesDict)
		goto RuntimeError;
	...
	if (!V24_BonesDict_InitBones(py_BonesDict))
		goto RuntimeError;
	if (!V24_BonesDict_InitEditBones(py_BonesDict))
		goto RuntimeError;
...
static PyObject *V24_Armature_makeEditable(V24_BPy_Armature *self)
{
	if (self->armature->flag & ARM_EDITMODE)
		goto AttributeError;

	make_boneList(&self->Bones->editbones, self->Bones->bones, NULL);
	if (!V24_BonesDict_InitEditBones(self->Bones))
		return NULL;
...
static PyObject *V24_Armature_update(V24_BPy_Armature *self)
{
	Object *obj = NULL;
	...
	if (obj){
		...
		if (!V24_BonesDict_InitBones(self->Bones))
			return NULL;
...
//------------------------Armature.__copy__()
static PyObject *V24_Armature_copy(V24_BPy_Armature *self)
{
	PyObject *py_armature = NULL;
	bArmature *bl_armature;
	bl_armature= copy_armature(self->armature);
	bl_armature->id.us= 0;
	py_armature= V24_Armature_CreatePyObject( bl_armature );
	return py_armature;
}

//------------------ATTRIBUTE IMPLEMENTATION---------------------------
//------------------------Armature.autoIK (getter)
static PyObject *V24_Armature_getAutoIK(V24_BPy_Armature *self, void *closure)
{
...
static int V24_Armature_setAutoIK(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	if(value){
...
static int V24_Armature_setLayers(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	if(value){
...
static PyObject *V24_Armature_getMirrorEdit(V24_BPy_Armature *self, void *closure)
{
...
static int V24_Armature_setMirrorEdit(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	if(value){
		if(PyBool_Check(value)){
			if (value == Py_True){
...
static PyObject *V24_Armature_getDrawType(V24_BPy_Armature *self, void *closure)
{
	if (self->armature->drawtype == ARM_OCTA){
		return V24_EXPP_GetModuleConstant("Blender.Armature", "OCTAHEDRON") ;
	}else if (self->armature->drawtype == ARM_LINE){
		return V24_EXPP_GetModuleConstant("Blender.Armature", "STICK") ;
	}else if (self->armature->drawtype == ARM_B_BONE){
		return V24_EXPP_GetModuleConstant("Blender.Armature", "BBONE") ;
	}else if (self->armature->drawtype == ARM_ENVELOPE){
		return V24_EXPP_GetModuleConstant("Blender.Armature", "ENVELOPE") ;
	}else{
		goto RuntimeError;
	}
...
static int V24_Armature_setStep(V24_BPy_Armature *self, PyObject *value, void *closure)
{
...
static int V24_Armature_setGhost(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	long numerical_value;
...
static int V24_Armature_setDrawNames(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	if(value){
		if(PyBool_Check(value)){
			if (value == Py_True){
...
static int V24_Armature_setDrawAxes(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	if(value){
		if(PyBool_Check(value)){
			if (value == Py_True){
...
static int V24_Armature_setDelayDeform(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	if(value){
		if(PyBool_Check(value)){
			if (value == Py_True){
...
static int V24_Armature_setRestPosition(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	if(value){
		if(PyBool_Check(value)){
			if (value == Py_True){
...
static int V24_Armature_setEnvelopes(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	if(value){
		if(PyBool_Check(value)){
			if (value == Py_True){
...
static int V24_Armature_setVertexGroups(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	if(value){
		if(PyBool_Check(value)){
			if (value == Py_True){
...
static PyObject *V24_Armature_getBoneDict(V24_BPy_Armature *self, void *closure)
{
...
static int V24_Armature_setBoneDict(V24_BPy_Armature *self, PyObject *value, void *closure)
{
	goto AttributeError;
...
//------------------------Bone.layerMask (get)
static PyObject *V24_Armature_getLayerMask(V24_BPy_Armature *self)
{
...
//------------------------Bone.layerMask (set)
static int V24_Armature_setLayerMask(V24_BPy_Armature *self, PyObject *value)
{
	int laymask;
	if (!PyInt_Check(value)) {
		return V24_EXPP_ReturnIntError( PyExc_AttributeError,
...
//------------------------tp_doc
//The __doc__ string for this object
static char V24_BPy_Armature_doc[] = "This object wraps a Blender Armature object.";
//------------------------tp_methods
//This contains a list of all methods the object contains
static PyMethodDef V24_BPy_Armature_methods[] = {
	{"makeEditable", (PyCFunction) V24_Armature_makeEditable, METH_NOARGS, 
		"() - Unlocks the ability to modify armature bones"},
	{"update", (PyCFunction) V24_Armature_update, METH_NOARGS, 
		"() - Rebuilds the armature based on changes to bones since the last call to makeEditable"},
	{"__copy__", (PyCFunction) V24_Armature_copy, METH_NOARGS, 
		"() - Return a copy of the armature."},
	{"copy", (PyCFunction) V24_Armature_copy, METH_NOARGS, 
		"() - Return a copy of the armature."},
	{NULL, NULL, 0, NULL}
};
//------------------------tp_getset
...
static PyGetSetDef V24_BPy_Armature_getset[] = {
	...
	{"envelopes", (getter)V24_Armature_getEnvelopes, (setter)V24_Armature_setEnvelopes, 
		"Enable/Disable bone envelope defined deformation", NULL},
	{"restPosition", (getter)V24_Armature_getRestPosition, (setter)V24_Armature_setRestPosition, 
		"Show armature rest position - disables posing", NULL},
	{"delayDeform", (getter)V24_Armature_getDelayDeform, (setter)V24_Armature_setDelayDeform, 
		"Don't deform children when manipulating bones in pose mode", NULL},
	{"drawAxes", (getter)V24_Armature_getDrawAxes, (setter)V24_Armature_setDrawAxes, 
		"Enable/Disable  drawing  the bone axes", NULL},
	{"drawNames", (getter)V24_Armature_getDrawNames, (setter)V24_Armature_setDrawNames, 
		"Enable/Disable  drawing the bone names", NULL},
	{"ghost", (getter)V24_Armature_getGhost, (setter)V24_Armature_setGhost, 
		"Draw a number of ghosts around the current frame for current Action", NULL},
	{"ghostStep", (getter)V24_Armature_getStep, (setter)V24_Armature_setStep, 
		"The number of frames between ghost instances", NULL},
	{"drawType", (getter)V24_Armature_getDrawType, (setter)V24_Armature_setDrawType, 
		"The type of drawing currently applied to the armature", NULL},
	{"mirrorEdit", (getter)V24_Armature_getMirrorEdit, (setter)V24_Armature_setMirrorEdit, 
		"Enable/Disable X-axis mirrored editing", NULL},
	{"autoIK", (getter)V24_Armature_getAutoIK, (setter)V24_Armature_setAutoIK, 
		"Adds temporal IK chains while grabbing bones", NULL},
	{"layers", (getter)V24_Armature_getLayers, (setter)V24_Armature_setLayers, 
		"List of layers for the armature", NULL},
	{"layerMask", (getter)V24_Armature_getLayerMask, (setter)V24_Armature_setLayerMask, 
		"Layer bitmask", NULL },
...
static PyObject *V24_Armature_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
	...
	if(bl_armature) {
		...
		py_armature = (V24_BPy_Armature*)type->tp_alloc(type, 0); //*new*
		if (py_armature == NULL)
			goto RuntimeError;
		...
		py_armature->Bones = (V24_BPy_BonesDict*)V24_PyBonesDict_FromPyArmature(py_armature);
...
/*****************************************************************************/
/* Function:	V24_Armature_compare						 */
/* Description: This is a callback function for the V24_BPy_Armature type. It	 */
/*		compares two V24_Armature_Type objects. Only the "==" and "!="  */
/*		comparisons are meaninful. Returns 0 for equality and -1 if  */
/*		they don't point to the same Blender Object struct.	 */
/*		In Python it becomes 1 if they are equal, 0 otherwise.	 */
/*****************************************************************************/
static int V24_Armature_compare( V24_BPy_Armature * a, V24_BPy_Armature * b )
{
...
//------------------------tp_repr
//This is the string representation of the object
static PyObject *V24_Armature_repr(V24_BPy_Armature *self)
{
...
PyTypeObject V24_Armature_Type = {
	PyObject_HEAD_INIT(NULL)		//tp_head
	0,								//tp_internal
	"Armature",						//tp_name
	...
	0,								//tp_getattr
	0,								//tp_setattr
	(cmpfunc) V24_Armature_compare,		//tp_compare
	(reprfunc) V24_Armature_repr,		//tp_repr
	0,								//tp_as_number
	0,								//tp_as_sequence
	0,								//tp_as_mapping
	( hashfunc ) V24_GenericLib_hash,	//tp_hash
	0,								//tp_call
	0,								//tp_str
	0,								//tp_getattro
	0,								//tp_setattro
	...
	V24_BPy_Armature_doc,				//tp_doc
	0,								//tp_traverse
	0,								//tp_clear
	0, 								//tp_richcompare
	offsetof(V24_BPy_Armature, weaklist),	//tp_weaklistoffset
	0,								//tp_iter
	0,								//tp_iternext
	V24_BPy_Armature_methods,			//tp_methods
	0,								//tp_members
	V24_BPy_Armature_getset,			//tp_getset
	0,								//tp_base
	0,								//tp_dict
	0,								//tp_descr_get
	0,								//tp_descr_set
...
static PyObject *V24_M_Armature_Get(PyObject * self, PyObject * args)
{
	...
	if (size == 1) {
		...
		seq = V24_EXPP_incr_ret(args); //*take ownership*
	}
	...
	if(size != 1){
		...
		if(size == 0){	//GET ALL ARMATURES
			...
			while (data){
				py_armature = V24_Armature_CreatePyObject(data); //*new*
				if (!py_armature) {
					V24_EXPP_decr2(seq, dict);
					return NULL; /* error is set from V24_Armature_CreatePyObject */
				}
				sprintf(buffer, "%s", ((bArmature*)data)->id.name +2);
				if(PyDict_SetItemString(dict, buffer, py_armature) == -1){ //add to dictionary
					V24_EXPP_decr3(seq, dict, py_armature);
					goto RuntimeError;
				}
		...
		data = find_id("AR", name); //get data from library
		if (data != NULL){
			return V24_Armature_CreatePyObject(data); //*new*
		}else{
			char buffer[128];
...
static PyObject *V24_M_Armature_New(PyObject * self, PyObject * args)
{
	...
	armature->id.us = 0;
	obj = (V24_BPy_Armature *)V24_Armature_CreatePyObject(armature); /*new*/
...
static char V24_M_Armature_Get_doc[] = "(name) - return the armature with the name 'name', \
...
//------------------------V24_Armature_RebuildEditbones (internal)
PyObject * V24_Armature_RebuildEditbones(PyObject *pyarmature)
{
	return V24_Armature_makeEditable((V24_BPy_Armature*)pyarmature);
}

//------------------------V24_Armature_RebuildBones (internal)
PyObject *V24_Armature_RebuildBones(PyObject *pyarmature)
{
	return V24_Armature_update((V24_BPy_Armature*)pyarmature);
}
...
PyObject *V24_Armature_CreatePyObject(struct bArmature *armature)
{
	...
	py_armature = PyObject_NEW( V24_BPy_Armature, &V24_Armature_Type );
...
PyObject *V24_Armature_Init(void)
{
	...
	if (PyType_Ready(&V24_Armature_Type) < 0 ||	PyType_Ready(&V24_BonesDict_Type) < 0 || 
		PyType_Ready(&V24_EditBone_Type) < 0 ||	PyType_Ready(&V24_Bone_Type) < 0) {
		return V24_EXPP_incr_ret(Py_None);
	}
	...
	PyModule_AddObject(module, "Armature", 
		V24_EXPP_incr_ret((PyObject *)&V24_Armature_Type)); //*steals*
	PyModule_AddObject(module, "Bone", 
		V24_EXPP_incr_ret((PyObject *)&V24_Bone_Type)); //*steals*
	PyModule_AddObject(module, "Editbone", 
		V24_EXPP_incr_ret((PyObject *)&V24_EditBone_Type)); //*steals*

	//Add CONSTANTS to the module
	PyModule_AddObject(module, "CONNECTED", 
		V24_PyConstant_NewInt("CONNECTED", BONE_CONNECTED));
	PyModule_AddObject(module, "HINGE", 
		V24_PyConstant_NewInt("HINGE", BONE_HINGE));
	PyModule_AddObject(module, "NO_DEFORM", 
		V24_PyConstant_NewInt("NO_DEFORM", BONE_NO_DEFORM));
	PyModule_AddObject(module, "MULTIPLY", 
		V24_PyConstant_NewInt("MULTIPLY", BONE_MULT_VG_ENV));
	PyModule_AddObject(module, "HIDDEN_EDIT", 
		V24_PyConstant_NewInt("HIDDEN_EDIT", BONE_HIDDEN_A));
	PyModule_AddObject(module, "ROOT_SELECTED", 
		V24_PyConstant_NewInt("ROOT_SELECTED", BONE_ROOTSEL));
	PyModule_AddObject(module, "BONE_SELECTED", 
		V24_PyConstant_NewInt("BONE_SELECTED", BONE_SELECTED));
	PyModule_AddObject(module, "TIP_SELECTED", 
		V24_PyConstant_NewInt("TIP_SELECTED", BONE_TIPSEL));

	PyModule_AddObject(module, "OCTAHEDRON", 
		V24_PyConstant_NewInt("OCTAHEDRON", ARM_OCTA));
	PyModule_AddObject(module, "STICK", 
		V24_PyConstant_NewInt("STICK", ARM_LINE));
	PyModule_AddObject(module, "BBONE", 
		V24_PyConstant_NewInt("BBONE", ARM_B_BONE));
	PyModule_AddObject(module, "ENVELOPE", 
		V24_PyConstant_NewInt("ENVELOPE", ARM_ENVELOPE));

	//Add SUBMODULES to the module
	dict = PyModule_GetDict( module ); //borrowed
	PyDict_SetItemString(dict, "NLA", V24_NLA_Init()); //creates a *new* module
