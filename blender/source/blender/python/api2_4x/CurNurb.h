/*
 * $Id: CurNurb.h 12898 2007-12-15 21:44:40Z campbellbarton $
...
#ifndef V24_EXPP_NURB_H
#define V24_EXPP_NURB_H
...
#define V24_BPy_CurNurb_Check(v)  ((v)->ob_type == &V24_CurNurb_Type)	/* for type checking */
