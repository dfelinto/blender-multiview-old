...
/**
 * Adapted to new API.
 * Used by the Blender Web Plugin
 */
...
/* { */
//	return CallNPN_GetURLNotifyProc(gNetscapeFuncs.geturl, instance, url, data);
/* 	return CallNPN_GetURLNotifyProc(gNetscapeFuncs.geturlnotify, instance, url, window, data); */
/* } */
...
{
	CallNPN_ForceRedrawProc(gNetscapeFuncs.forceredraw,
				instance);
}
...
{
	CallNPN_InvalidateRectProc(gNetscapeFuncs.invalidaterect,instance,invalidRect);
}
...
NP_Initialize(NPNetscapeFuncs* nsTable, NPPluginFuncs* pluginFuncs)
{
	...
	if (err == NPERR_NO_ERROR) {
		...
		/* nzc added this: inside mozilla code, this is
		 * rerouted to _geturlnotify, which in its turn is
		 * rerouted to the proper cpp call */
