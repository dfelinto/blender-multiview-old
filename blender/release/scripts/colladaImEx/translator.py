    ...
    def Export(self, fileName):
        ...
        for bScene in Blender.Scene.Get():
            ...
            if daeVisualScene is None:
                ...
                daeVisualScene = sceneGraph.SaveToDae(bScene)
...
##                pass#self.document.currentBScene.unlink(bNode)   
    ...
    def SaveToDae(self, bScene):
        ...
        for rootNode in self.rootNodes:
            sceneNode = SceneNode(self.document,self)
            daeNode = sceneNode.SaveToDae(rootNode,self.childNodes)
...
##                                print b.co
    ...
    def SaveToDae(self, bMesh):
        ...
        daeGeometry.id = daeGeometry.name = bMesh.name
        ...
        daeSource.id = daeGeometry.id+'-Position'
        daeFloatArray = collada.DaeFloatArray()
        daeFloatArray.id = daeSource.id+'-array'
        ...
        daeSourceNormals.id = daeGeometry.id+'-Normals'
        daeFloatArrayNormals = collada.DaeFloatArray()
        daeFloatArrayNormals.id = daeSourceNormals.id+'-array'
        ...
        daeSourceTextures.id = daeGeometry.id + '-UV'
        daeFloatArrayTextures = collada.DaeFloatArray()
        daeFloatArrayTextures.id = daeSourceTextures.id+'-array'
        ...
        daeVertices.id = daeGeometry.id+'-Vertex'
...
class MaterialNode(object):
    ...
    def SaveToDae(self, bMaterial):
        ...
        daeMaterial.id = daeMaterial.name = bMaterial.name        
        ...
        if daeEffect is None:
            ...
            daeEffect.id = daeEffect.name = bMaterial.name + '-fx'
            shader = None
...
class CameraNode(object):
    ...
    def SaveToDae(self, bCamera):
        ...
        daeCamera.id = daeCamera.name = bCamera.name
