...
%macro DCT_8_INV_COL 2
  movq mm0, [tg_3_16 wrt rip]
  movq mm3, [%1+16*3]
  movq mm1, mm0             ; tg_3_16
  movq mm5, [%1+16*5]
  pmulhw mm0, mm3           ; x3*(tg_3_16-1)
  movq mm4, [tg_1_16 wrt rip]
...
idct_x86_64:
    ...
    ;; Process each row
    lea rsi, [tab_i_04_xmm wrt rip]
    lea rdi, [rounder_0 wrt rip]
    DCT_8_INV_ROW_XMM rax+0*16, rax+0*16, rsi, rdi
    
    lea rsi, [tab_i_17_xmm wrt rip]
    lea rdi, [rounder_1 wrt rip]
    DCT_8_INV_ROW_XMM rax+1*16, rax+1*16, rsi, rdi
    
    lea rsi, [tab_i_26_xmm wrt rip]
    lea rdi, [rounder_2 wrt rip]
    DCT_8_INV_ROW_XMM rax+2*16, rax+2*16, rsi, rdi
    
    lea rsi, [tab_i_35_xmm wrt rip]
    lea rdi, [rounder_3 wrt rip]
    DCT_8_INV_ROW_XMM rax+3*16, rax+3*16, rsi, rdi
    
    lea rsi, [tab_i_04_xmm wrt rip]
    lea rdi, [rounder_4 wrt rip]
    DCT_8_INV_ROW_XMM rax+4*16, rax+4*16, rsi, rdi
    
    lea rsi, [tab_i_35_xmm wrt rip]
    lea rdi, [rounder_5 wrt rip]
    DCT_8_INV_ROW_XMM rax+5*16, rax+5*16, rsi, rdi
    
    lea rsi, [tab_i_26_xmm wrt rip]
    lea rdi, [rounder_6 wrt rip]
    DCT_8_INV_ROW_XMM rax+6*16, rax+6*16, rsi, rdi
    
    lea rsi, [tab_i_17_xmm wrt rip]
    lea rdi, [rounder_7 wrt rip]
    DCT_8_INV_ROW_XMM rax+7*16, rax+7*16, rsi, rdi


    ;; Process the columns (4 at a time)
    DCT_8_INV_COL rax+0, rax+0
    DCT_8_INV_COL rax+8, rax+8
